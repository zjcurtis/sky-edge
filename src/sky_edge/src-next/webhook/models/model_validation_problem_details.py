...
T = TypeVar("T", bound="ModelValidationProblemDetails")


@_attrs_define
class ModelValidationProblemDetails:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_validation_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        model_validation_problem_details.additional_properties = d
        return model_validation_problem_details
