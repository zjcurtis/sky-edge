...
T = TypeVar("T", bound="DeleteSubscriptionBadRequestResponse")


@_attrs_define
class DeleteSubscriptionBadRequestResponse:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:subscription-is-
            provisioning</td><td>This operation cannot be done while the subscription is Provisioning. Please wait for
            subscription to provision. If stuck, the subscription can be deleted after 30 minutes regardless of provisioning
            state.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_subscription_bad_request_response = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_subscription_bad_request_response.additional_properties = d
        return delete_subscription_bad_request_response
