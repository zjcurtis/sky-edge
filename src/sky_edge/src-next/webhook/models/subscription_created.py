...
from ..models.subscription_created_provisioning_status import SubscriptionCreatedProvisioningStatus
...
class SubscriptionCreated:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_provisioning_status, Unset):
            ...
            provisioning_status = SubscriptionCreatedProvisioningStatus(_provisioning_status)
