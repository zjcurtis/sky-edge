...
T = TypeVar("T", bound="GetSubscriptionBadRequestResponse")


@_attrs_define
class GetSubscriptionBadRequestResponse:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            type</td><td>{0} is not a valid event type</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_subscription_bad_request_response = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_subscription_bad_request_response.additional_properties = d
        return get_subscription_bad_request_response
