...
T = TypeVar("T", bound="SendTestPayloadToSubscriptionBadRequestResponse")


@_attrs_define
class SendTestPayloadToSubscriptionBadRequestResponse:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:webhook-url-
            unreachable</td><td>We were unable to reach the specified webhook URL. Please check the URL and try
            again.</td></tr><tr><td>urn:blackbaud:webhook-event-invalid-status-code</td><td>Your webhook returned an invalid
            HTTP status code when sent the test event payload. Valid status codes: 200 -
            204.</td></tr><tr><td>urn:blackbaud:webhook-event-timeout</td><td>Your webhook failed to respond in 30 seconds
            ...
            unexpectedly terminated during the request.</td></tr><tr><td>urn:blackbaud:subscription-not-
            provisioned</td><td>Only Provisioned subscriptions can be sent an event.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        send_test_payload_to_subscription_bad_request_response = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        send_test_payload_to_subscription_bad_request_response.additional_properties = d
        return send_test_payload_to_subscription_bad_request_response
