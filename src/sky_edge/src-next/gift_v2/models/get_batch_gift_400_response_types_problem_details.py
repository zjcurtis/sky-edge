...
T = TypeVar("T", bound="GetBatchGift400ResponseTypesProblemDetails")


@_attrs_define
class GetBatchGift400ResponseTypesProblemDetails:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            argument-not-assigned-value</td><td>The required argument '{0}' was not assigned a value.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_batch_gift_400_response_types_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_batch_gift_400_response_types_problem_details.additional_properties = d
        return get_batch_gift_400_response_types_problem_details
