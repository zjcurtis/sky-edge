...
T = TypeVar("T", bound="GetPledgePayments400ResponseTypesProblemDetails")


@_attrs_define
class GetPledgePayments400ResponseTypesProblemDetails:
    """The problem details when a 400 status code is returned for the GetPledgePayments endpoint
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            valid for the operation: {0}</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pledge_payments_400_response_types_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_pledge_payments_400_response_types_problem_details.additional_properties = d
        return get_pledge_payments_400_response_types_problem_details
