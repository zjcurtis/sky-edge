...
T = TypeVar("T", bound="AddEditBatchGift400ResponseTypesProblemDetails")


@_attrs_define
class AddEditBatchGift400ResponseTypesProblemDetails:
    """The problem details when a 400 status code is returned for the GetBatchGift endpoint
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            value.</td></tr><tr><td>urn:blackbaud:gift-argument-not-valid</td><td>There were issues with the contract:
            {0}</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_edit_batch_gift_400_response_types_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        add_edit_batch_gift_400_response_types_problem_details.additional_properties = d
        return add_edit_batch_gift_400_response_types_problem_details
