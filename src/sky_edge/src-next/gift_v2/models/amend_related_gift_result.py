...
class AmendRelatedGiftResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recurring_gift_legacy_id = _parse_recurring_gift_legacy_id(d.pop("recurring_gift_legacy_id", UNSET))
        ...
        amendment_legacy_id = _parse_amendment_legacy_id(d.pop("amendment_legacy_id", UNSET))
