...
from ..models.batch_gift_tribute_gift_tribute_acknowledge_status import BatchGiftTributeGiftTributeAcknowledgeStatus
...
class BatchGiftTribute:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.can_view_honor_or_memorial_constituent, Unset):
            ...
            can_view_honor_or_memorial_constituent = self.can_view_honor_or_memorial_constituent
        ...
        if can_view_honor_or_memorial_constituent is not UNSET:
            field_dict["can_view_honor_or_memorial_constituent"] = can_view_honor_or_memorial_constituent
        ...
        if honor_or_memorial_constituent_id is not UNSET:
            field_dict["honor_or_memorial_constituent_id"] = honor_or_memorial_constituent_id
        if honor_or_memorial_constituent_name is not UNSET:
            field_dict["honor_or_memorial_constituent_name"] = honor_or_memorial_constituent_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_acknowledgees(data: object) -> list[BatchGiftTributeAcknowledgee] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for acknowledgees_type_0_item_data in _acknowledgees_type_0:
                    acknowledgees_type_0_item = BatchGiftTributeAcknowledgee.from_dict(acknowledgees_type_0_item_data)
        ...
        if isinstance(_acknowledge_status, Unset):
            ...
            acknowledge_status = BatchGiftTributeGiftTributeAcknowledgeStatus(_acknowledge_status)

        def _parse_can_view_honor_or_memorial_constituent(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        can_view_honor_or_memorial_constituent = _parse_can_view_honor_or_memorial_constituent(
        ...
        def _parse_honor_or_memorial_constituent_name(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        tribute_description = _parse_tribute_description(d.pop("tribute_description", UNSET))
        ...
        tribute_type_description = _parse_tribute_type_description(d.pop("tribute_type_description", UNSET))
