...
from ..models.batch_gift_read_gift_post_status import BatchGiftReadGiftPostStatus
from ..models.batch_gift_read_gift_status import BatchGiftReadGiftStatus
from ..models.batch_gift_read_gift_type import BatchGiftReadGiftType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.batch_gift_custom_field_read import BatchGiftCustomFieldRead
    from ..models.batch_gift_error_record import BatchGiftErrorRecord
    from ..models.batch_gift_extension_list_item import BatchGiftExtensionListItem
    ...
    from ..models.batch_gift_tribute import BatchGiftTribute
...
@_attrs_define
class BatchGiftRead:
    """A batch gift record stored in the system

    Attributes:
        extensions (list[BatchGiftExtensionListItem] | None | Unset): Extension data documents associated with this
            batch gift.
        id (None | str | Unset): ID of the batch gift
        ...
        custom_fields (list[BatchGiftCustomFieldRead] | None | Unset): Custom fields associated with the batch gift
        batch_gift_errors (list[BatchGiftErrorRecord] | None | Unset): Validation errors
        tributes (list[BatchGiftTribute] | None | Unset): Tributes associated with the batch gift
        ...
        gift_post_status (BatchGiftReadGiftPostStatus | Unset): The post status of the gift. Example: NotPosted.
        gift_type (BatchGiftReadGiftType | Unset): The gift type. Example: Donation.
        ...
        gift_status (BatchGiftReadGiftStatus | Unset): The status of a gift. Example: Active.
    ...
    extensions: list[BatchGiftExtensionListItem] | None | Unset = UNSET
    id: None | str | Unset = UNSET
    batch_number: None | str | Unset = UNSET
    date_added: datetime.datetime | None | Unset = UNSET
    custom_fields: list[BatchGiftCustomFieldRead] | None | Unset = UNSET
    batch_gift_errors: list[BatchGiftErrorRecord] | None | Unset = UNSET
    tributes: list[BatchGiftTribute] | None | Unset = UNSET
    ...
    gift_post_status: BatchGiftReadGiftPostStatus | Unset = UNSET
    gift_type: BatchGiftReadGiftType | Unset = UNSET
    ...
    gift_status: BatchGiftReadGiftStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        batch_gift_errors: list[dict[str, Any]] | None | Unset
        if isinstance(self.batch_gift_errors, Unset):
            batch_gift_errors = UNSET
        elif isinstance(self.batch_gift_errors, list):
            batch_gift_errors = []
            for batch_gift_errors_type_0_item_data in self.batch_gift_errors:
                batch_gift_errors_type_0_item = batch_gift_errors_type_0_item_data.to_dict()
                batch_gift_errors.append(batch_gift_errors_type_0_item)

        else:
            batch_gift_errors = self.batch_gift_errors
        ...
        if isinstance(self.installment_payments, Unset):
            ...
            for installment_payments_type_0_item_data in self.installment_payments:
                installment_payments_type_0_item = installment_payments_type_0_item_data.to_dict()
        ...
        if isinstance(self.fundraiser_credits, Unset):
            ...
            for fundraiser_credits_type_0_item_data in self.fundraiser_credits:
                fundraiser_credits_type_0_item = fundraiser_credits_type_0_item_data.to_dict()
        ...
        if isinstance(self.acknowledgements, Unset):
            ...
            for acknowledgements_type_0_item_data in self.acknowledgements:
                acknowledgements_type_0_item = acknowledgements_type_0_item_data.to_dict()
        ...
        if batch_gift_errors is not UNSET:
            field_dict["batch_gift_errors"] = batch_gift_errors
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extensions(data: object) -> list[BatchGiftExtensionListItem] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for extensions_type_0_item_data in _extensions_type_0:
                    extensions_type_0_item = BatchGiftExtensionListItem.from_dict(extensions_type_0_item_data)
                ...
                pass
            return cast(list[BatchGiftExtensionListItem] | None | Unset, data)
        ...
        def _parse_custom_fields(data: object) -> list[BatchGiftCustomFieldRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for custom_fields_type_0_item_data in _custom_fields_type_0:
                    custom_fields_type_0_item = BatchGiftCustomFieldRead.from_dict(custom_fields_type_0_item_data)
                ...
                pass
            return cast(list[BatchGiftCustomFieldRead] | None | Unset, data)

        custom_fields = _parse_custom_fields(d.pop("custom_fields", UNSET))

        def _parse_batch_gift_errors(data: object) -> list[BatchGiftErrorRecord] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                batch_gift_errors_type_0 = []
                _batch_gift_errors_type_0 = data
                for batch_gift_errors_type_0_item_data in _batch_gift_errors_type_0:
                    batch_gift_errors_type_0_item = BatchGiftErrorRecord.from_dict(batch_gift_errors_type_0_item_data)

                    batch_gift_errors_type_0.append(batch_gift_errors_type_0_item)

                return batch_gift_errors_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(list[BatchGiftErrorRecord] | None | Unset, data)

        batch_gift_errors = _parse_batch_gift_errors(d.pop("batch_gift_errors", UNSET))

        def _parse_tributes(data: object) -> list[BatchGiftTribute] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tributes_type_0_item_data in _tributes_type_0:
                    tributes_type_0_item = BatchGiftTribute.from_dict(tributes_type_0_item_data)
                ...
                pass
            return cast(list[BatchGiftTribute] | None | Unset, data)

        tributes = _parse_tributes(d.pop("tributes", UNSET))

        def _parse_installments(data: object) -> list[BatchGiftInstallment] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for installments_type_0_item_data in _installments_type_0:
                    installments_type_0_item = BatchGiftInstallment.from_dict(installments_type_0_item_data)
        ...
        def _parse_installment_payments(data: object) -> list[BatchGiftInstallmentPayment] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for installment_payments_type_0_item_data in _installment_payments_type_0:
                    installment_payments_type_0_item = BatchGiftInstallmentPayment.from_dict(
        ...
        installment_payments = _parse_installment_payments(d.pop("installment_payments", UNSET))
        ...
        def _parse_gift_splits(data: object) -> list[BatchGiftSplit] | None | Unset:
            ...
            try:
                ...
                for gift_splits_type_0_item_data in _gift_splits_type_0:
                    gift_splits_type_0_item = BatchGiftSplit.from_dict(gift_splits_type_0_item_data)
        ...
        def _parse_fundraiser_credits(data: object) -> list[BatchGiftFundraiserCredit] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for fundraiser_credits_type_0_item_data in _fundraiser_credits_type_0:
                    fundraiser_credits_type_0_item = BatchGiftFundraiserCredit.from_dict(
        ...
        fundraiser_credits = _parse_fundraiser_credits(d.pop("fundraiser_credits", UNSET))

        def _parse_soft_credits(data: object) -> list[BatchGiftSoftCredit] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for soft_credits_type_0_item_data in _soft_credits_type_0:
                    soft_credits_type_0_item = BatchGiftSoftCredit.from_dict(soft_credits_type_0_item_data)
        ...
        gift_post_status: BatchGiftReadGiftPostStatus | Unset
        if isinstance(_gift_post_status, Unset):
            gift_post_status = UNSET
        else:
            gift_post_status = BatchGiftReadGiftPostStatus(_gift_post_status)

        _gift_type = d.pop("gift_type", UNSET)
        gift_type: BatchGiftReadGiftType | Unset
        if isinstance(_gift_type, Unset):
            gift_type = UNSET
        else:
            gift_type = BatchGiftReadGiftType(_gift_type)
        ...
        def _parse_payments(data: object) -> list[GiftPaymentRecord] | None | Unset:
            ...
            try:
                ...
                for payments_type_0_item_data in _payments_type_0:
                    payments_type_0_item = GiftPaymentRecord.from_dict(payments_type_0_item_data)
        ...
        def _parse_receipts(data: object) -> list[GiftReceipt] | None | Unset:
            ...
            try:
                ...
                for receipts_type_0_item_data in _receipts_type_0:
                    receipts_type_0_item = GiftReceipt.from_dict(receipts_type_0_item_data)
        ...
        def _parse_acknowledgements(data: object) -> list[GiftAcknowledgement] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for acknowledgements_type_0_item_data in _acknowledgements_type_0:
                    acknowledgements_type_0_item = GiftAcknowledgement.from_dict(acknowledgements_type_0_item_data)
        ...
        gift_status: BatchGiftReadGiftStatus | Unset
        if isinstance(_gift_status, Unset):
            gift_status = UNSET
        else:
            gift_status = BatchGiftReadGiftStatus(_gift_status)
        ...
        batch_gift_read = cls(
            ...
            batch_gift_errors=batch_gift_errors,
            tributes=tributes,
