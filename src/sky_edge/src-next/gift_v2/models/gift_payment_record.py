...
from ..models.gift_payment_record_processing_status import GiftPaymentRecordProcessingStatus
...
class GiftPaymentRecord:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        checkout_transaction_id = _parse_checkout_transaction_id(d.pop("checkout_transaction_id", UNSET))
        ...
        bbps_transaction_id = _parse_bbps_transaction_id(d.pop("bbps_transaction_id", UNSET))
        ...
        charge_transaction = _parse_charge_transaction(d.pop("charge_transaction", UNSET))
        ...
        def _parse_pad_mandates(data: object) -> list[PadMandate] | None | Unset:
            ...
            try:
                ...
                for pad_mandates_type_0_item_data in _pad_mandates_type_0:
                    pad_mandates_type_0_item = PadMandate.from_dict(pad_mandates_type_0_item_data)
