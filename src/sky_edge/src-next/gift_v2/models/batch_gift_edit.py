...
class BatchGiftEdit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_fields(data: object) -> list[BatchGiftCustomFieldEdit] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for custom_fields_type_0_item_data in _custom_fields_type_0:
                    custom_fields_type_0_item = BatchGiftCustomFieldEdit.from_dict(custom_fields_type_0_item_data)
