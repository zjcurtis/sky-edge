...
T = TypeVar("T", bound="IssuerDetailsEdit")


@_attrs_define
class IssuerDetailsEdit:
    """Represents edits to the issuer details.

    Attributes:
        issuer (None | str | Unset): Issuer name
        symbol (None | str | Unset): Issuer symbol
        units (int | None | Unset): Number of units of stock
        unit_price (float | None | Unset): Median unit price
    """
