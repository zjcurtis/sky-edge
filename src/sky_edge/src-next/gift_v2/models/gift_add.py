...
from ..models.gift_add_gift_post_status import GiftAddGiftPostStatus
from ..models.gift_add_gift_status import GiftAddGiftStatus
from ..models.gift_add_gift_type import GiftAddGiftType
...
@_attrs_define
class GiftAdd:
    """A new gift to be added.

    Attributes:
        amount (Currency): An amount denominated in a specific currency.
        gift_type (GiftAddGiftType): The gift type.
        ...
        comments (None | str | Unset): Comments associated with the gift. Character limit: 255. Example: This is a
            comment.
        gift_post_status (GiftAddGiftPostStatus | Unset): The post status of the gift. Example: NotPosted.
        ...
        gift_status (GiftAddGiftStatus | Unset): The status of a gift. Example: Active.
    ...
    gift_post_status: GiftAddGiftPostStatus | Unset = UNSET
    ...
    gift_status: GiftAddGiftStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gift_type = GiftAddGiftType(d.pop("gift_type"))
        ...
        gift_post_status: GiftAddGiftPostStatus | Unset
        if isinstance(_gift_post_status, Unset):
            gift_post_status = UNSET
        else:
            gift_post_status = GiftAddGiftPostStatus(_gift_post_status)
        ...
        gift_status: GiftAddGiftStatus | Unset
        if isinstance(_gift_status, Unset):
            gift_status = UNSET
        else:
            gift_status = GiftAddGiftStatus(_gift_status)
