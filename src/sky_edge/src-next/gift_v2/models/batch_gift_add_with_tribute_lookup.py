...
from ..models.batch_gift_add_with_tribute_lookup_gift_post_status import BatchGiftAddWithTributeLookupGiftPostStatus
from ..models.batch_gift_add_with_tribute_lookup_gift_status import BatchGiftAddWithTributeLookupGiftStatus
from ..models.batch_gift_add_with_tribute_lookup_gift_type import BatchGiftAddWithTributeLookupGiftType
...
class BatchGiftAddWithTributeLookup:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tributes(data: object) -> list[TributeLookup] | None | Unset:
            ...
            try:
                ...
                for tributes_type_0_item_data in _tributes_type_0:
                    tributes_type_0_item = TributeLookup.from_dict(tributes_type_0_item_data)
        ...
        if isinstance(_gift_post_status, Unset):
            ...
            gift_post_status = BatchGiftAddWithTributeLookupGiftPostStatus(_gift_post_status)
