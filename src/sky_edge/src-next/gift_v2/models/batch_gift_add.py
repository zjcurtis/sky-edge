...
from ..models.batch_gift_add_gift_post_status import BatchGiftAddGiftPostStatus
from ..models.batch_gift_add_gift_status import BatchGiftAddGiftStatus
from ..models.batch_gift_add_gift_type import BatchGiftAddGiftType
...
T = TypeVar("T", bound="BatchGiftAdd")


@_attrs_define
class BatchGiftAdd:
    """A new batch gift to be added

    Attributes:
        amount (Currency): An amount denominated in a specific currency.
        gift_type (BatchGiftAddGiftType): The gift type.
        constituent (GiftConstituent): The constituent who makes a gift.
        batch_gift_id (None | str | Unset): System ID of the batch gift. Example: 12345.
        batch_id (None | str | Unset): ID of the batch which this gift belongs to Example: 12345.
        tributes (list[GiftTributeAdd] | None | Unset): Tributes for this batch gift
        ...
        comments (None | str | Unset): Comments associated with the gift. Character limit: 255. Example: This is a
            comment.
        gift_post_status (BatchGiftAddGiftPostStatus | Unset): The post status of the gift. Example: NotPosted.
        ...
        gift_status (BatchGiftAddGiftStatus | Unset): The status of a gift. Example: Active.
    ...
    amount: Currency
    gift_type: BatchGiftAddGiftType
    ...
    gift_post_status: BatchGiftAddGiftPostStatus | Unset = UNSET
    ...
    gift_status: BatchGiftAddGiftStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.pledge_installments, Unset):
            ...
            for pledge_installments_type_0_item_data in self.pledge_installments:
                pledge_installments_type_0_item = pledge_installments_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gift_type = BatchGiftAddGiftType(d.pop("gift_type"))
        ...
        def _parse_tributes(data: object) -> list[GiftTributeAdd] | None | Unset:
            ...
            try:
                ...
                for tributes_type_0_item_data in _tributes_type_0:
                    tributes_type_0_item = GiftTributeAdd.from_dict(tributes_type_0_item_data)
        ...
        def _parse_gift_splits(data: object) -> list[GiftSplit] | None | Unset:
            ...
            try:
                ...
                for gift_splits_type_0_item_data in _gift_splits_type_0:
                    gift_splits_type_0_item = GiftSplit.from_dict(gift_splits_type_0_item_data)
        ...
        def _parse_apply_payments(data: object) -> list[ApplyPayment] | None | Unset:
            ...
            try:
                ...
                for apply_payments_type_0_item_data in _apply_payments_type_0:
                    apply_payments_type_0_item = ApplyPayment.from_dict(apply_payments_type_0_item_data)
        ...
        charge_first_payment = _parse_charge_first_payment(d.pop("charge_first_payment", UNSET))
        ...
        def _parse_custom_fields(data: object) -> list[GiftCustomFieldAdd] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for custom_fields_type_0_item_data in _custom_fields_type_0:
                    custom_fields_type_0_item = GiftCustomFieldAdd.from_dict(custom_fields_type_0_item_data)
        ...
        processes_manually = _parse_processes_manually(d.pop("processes_manually", UNSET))

        def _parse_pledge_installments(data: object) -> list[PledgeInstallmentAdd] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        pledge_installments = _parse_pledge_installments(d.pop("pledge_installments", UNSET))
        ...
        gift_post_status: BatchGiftAddGiftPostStatus | Unset
        if isinstance(_gift_post_status, Unset):
            gift_post_status = UNSET
        else:
            gift_post_status = BatchGiftAddGiftPostStatus(_gift_post_status)
        ...
        def _parse_fundraiser_credits(data: object) -> list[FundraiserCredit] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for fundraiser_credits_type_0_item_data in _fundraiser_credits_type_0:
                    fundraiser_credits_type_0_item = FundraiserCredit.from_dict(fundraiser_credits_type_0_item_data)
        ...
        def _parse_soft_credits(data: object) -> list[SoftCredit] | None | Unset:
            ...
            try:
                ...
                for soft_credits_type_0_item_data in _soft_credits_type_0:
                    soft_credits_type_0_item = SoftCredit.from_dict(soft_credits_type_0_item_data)
        ...
        gift_status: BatchGiftAddGiftStatus | Unset
        if isinstance(_gift_status, Unset):
            gift_status = UNSET
        else:
            gift_status = BatchGiftAddGiftStatus(_gift_status)
