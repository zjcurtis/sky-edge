...
from ..models.gift_acknowledgement_acknowledgement_status import GiftAcknowledgementAcknowledgementStatus
...
class GiftAcknowledgement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_acknowledgement_date(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        acknowledgement_date = _parse_acknowledgement_date(d.pop("acknowledgement_date", UNSET))
