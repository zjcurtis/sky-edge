...
class ApplyPayment:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_installments(data: object) -> list[ApplyPaymentInstallment] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for installments_type_0_item_data in _installments_type_0:
                    installments_type_0_item = ApplyPaymentInstallment.from_dict(installments_type_0_item_data)
