...
class GiftValidationErrorInvalidInputErrorCode(str, Enum):
    ...
    ADJUSTINGGIFTAFTERPROCESSINGREFUNDFAILED = "AdjustingGiftAfterProcessingRefundFailed"
    AMENDSCHEDULEVALIDATIONNOTAVAILABLE = "AmendScheduleValidationNotAvailable"
    APPLYPAYMENTCANNOTPROVIDEDUPLICATEINSTALLMENTS = "ApplyPaymentCannotProvideDuplicateInstallments"
    ...
    AUTOMATEDPLEDGEINSTALLMENTUPDATEMUSTBEAFTERTODAY = "AutomatedPledgeInstallmentUpdateMustBeAfterToday"
    CANADIANDIRECTDEBITGIFTCANNOTBEADDED = "CanadianDirectDebitGiftCannotBeAdded"
    CANADIANDIRECTDEBITREQUIRESPADMANDATEURL = "CanadianDirectDebitRequiresPADMandateUrl"
    CANNOTADDGIFTTOAPPROVEDBATCH = "CannotAddGiftToApprovedBatch"
    CANNOTCHARGECREDITCARDWITHOUTTRANSACTIONID = "CannotChargeCreditCardWithoutTransactionId"
    CANNOTCHARGEDIRECTDEBITWITHOUTACCOUNTTOKENORTRANSACTIONID = (
        "CannotChargeDirectDebitWithoutAccountTokenOrTransactionId"
    )
    CANNOTCHARGEDIRECTDEBITWITHOUTTRANSACTIONID = "CannotChargeDirectDebitWithoutTransactionId"
    ...
    CHARGETRANSACTIONNOTSUPPORTEDFORGIFTTYPE = "ChargeTransactionNotSupportedForGiftType"
    CONSTITUENTIDNOTFOUND = "ConstituentIdNotFound"
    CREDITCARDTYPEINVALID = "CreditCardTypeInvalid"
    CUSTOMFIELDDESCRIPTIONDOESNOTMATCHCATEGORYDATATYPE = "CustomFieldDescriptionDoesNotMatchCategoryDataType"
    ...
    GIFTACKNOWLEDGEMENTMUSTHAVEVALIDACKNOWLEDGEMENTSTATUS = "GiftAcknowledgementMustHaveValidAcknowledgementStatus"
    ...
    GIFTCHILDITEMREQUIREDARGUMENTNOTASSIGNEDVALUE = "GiftChildItemRequiredArgumentNotAssignedValue"
    GIFTCODEINVALID = "GiftCodeInvalid"
    GIFTCONSTITUENCYINVALID = "GiftConstituencyInvalid"
    GIFTCUSTOMFIELDACTIVECATEGORYDOESNOTEXIST = "GiftCustomFieldActiveCategoryDoesNotExist"
    ...
    GIFTCUSTOMFIELDSMULTIPLEONEPERRECORDTYPECATEGORIESADDED = "GiftCustomFieldsMultipleOnePerRecordTypeCategoriesAdded"
    ...
    GIFTNONCHECKNONDIRECTDEBITPAYMENTMUSTNOTHAVECHECKNUMBER = "GiftNonCheckNonDirectDebitPaymentMustNotHaveCheckNumber"
    ...
    GIFTNONCREDITCARDPAYMENTMUSTNOTHAVEAUTHORIZATIONCODE = "GiftNonCreditCardPaymentMustNotHaveAuthorizationCode"
    GIFTNONCREDITCARDPAYMENTMUSTNOTHAVECARDHOLDER = "GiftNonCreditCardPaymentMustNotHaveCardholder"
    GIFTNONCREDITCARDPAYMENTMUSTNOTHAVECARDTYPE = "GiftNonCreditCardPaymentMustNotHaveCardType"
    GIFTONLYONEITEMALLOWED = "GiftOnlyOneItemAllowed"
    GIFTOPPORTUNITYAMOUNTCANNOTEXCEEDGIFTAMOUNT = "GiftOpportunityAmountCannotExceedGiftAmount"
    ...
    GIFTPAYMENTINFORMATIONNOTAVAILABLEFORAMENDMENT = "GiftPaymentInformationNotAvailableForAmendment"
    GIFTPAYMENTMETHODINVALID = "GiftPaymentMethodInvalid"
    GIFTPAYMENTMETHODMUSTBECREDITCARDTOPROCESSREFUND = "GiftPaymentMethodMustBeCreditCardToProcessRefund"
    GIFTPAYMENTMISSINGAMOUNT = "GiftPaymentMissingAmount"
    GIFTPAYMENTMUSTBEGREATERTHANZEROTOPROCESSREFUND = "GiftPaymentMustBeGreaterThanZeroToProcessRefund"
    GIFTPAYMENTMUSTHAVETRANSACTIONIDTOPROCESSREFUND = "GiftPaymentMustHaveTransactionIdToProcessRefund"
    GIFTPAYMENTTRANSACTIONIDMUSTBEVALIDGUIDTOPROCESSREFUND = "GiftPaymentTransactionIdMustBeValidGuidToProcessRefund"
    GIFTRECEIPTHASSTACKFIELDSBUTCAPABILITYNOTENABLED = "GiftReceiptHasStackFieldsButCapabilityNotEnabled"
    ...
    GIFTSPLITTOTALAMOUNTDOESNOTEQUALGIFTAMOUNT = "GiftSplitTotalAmountDoesNotEqualGiftAmount"
    ...
    GIFTWITHDONORCOVERCANNOTBEAPPLIEDTOPLEDGE = "GiftWithDonorCoverCannotBeAppliedToPledge"
    INSTALLMENTPAYMENTAMOUNTMUSTMATCHINSTALLMENTBALANCE = "InstallmentPaymentAmountMustMatchInstallmentBalance"
    INSTALLMENTSMUSTEXISTTOAPPLYPAYMENT = "InstallmentsMustExistToApplyPayment"
    INVALIDAPPLYPAYMENTSFORBATCHRECURRINGPAYMENT = "InvalidApplyPaymentsForBatchRecurringPayment"
    ...
    INVALIDID = "InvalidId"
    INVALIDNUMBEROFINSTALLMENTSFORSINGLESCHEDULE = "InvalidNumberOfInstallmentsForSingleSchedule"
    INVALIDOPPORTUNITYID = "InvalidOpportunityId"
    INVALIDPAYMENTCONFIGURATIONID = "InvalidPaymentConfigurationId"
    INVALIDSCHEDULEDINSTALLMENTDATEAMENDGIFT = "InvalidScheduledInstallmentDateAmendGift"
    ...
    NONACKNOWLEDGEDGIFTCANNOTHAVEACKNOWLEDGEMENTDATE = "NonAcknowledgedGiftCannotHaveAcknowledgementDate"
    ...
    NUMBEROFTRANSACTIONIDSPROVIDEDEXCEEDSLIMIT = "NumberOfTransactionIdsProvidedExceedsLimit"
    PADMANDATESAREINVALIDFORGIFT = "PADMandatesAreInvalidForGift"
    PAYMENTAMENDMENTIDANDORIGINALGIFTIDMISMATCH = "PaymentAmendmentIdAndOriginalGiftIdMismatch"
    ...
    PLEDGEINSTALLMENTDATEMUSTNOTPRECEDEGIFTDATE = "PledgeInstallmentDateMustNotPrecedeGiftDate"
    PLEDGEINSTALLMENTGENERATIONNUMBEROFINSTALLMENTSANDENDDATESET = (
        "PledgeInstallmentGenerationNumberOfInstallmentsAndEndDateSet"
    )
    PLEDGEINSTALLMENTNEGATIVEAMOUNTARGUMENTFOUND = "PledgeInstallmentNegativeAmountArgumentFound"
    PLEDGEINSTALLMENTPARENTGIFTISNOTPLEDGE = "PledgeInstallmentParentGiftIsNotPledge"
    PLEDGEINSTALLMENTSTOTALDOESNOTMATCHGIFTAMOUNT = "PledgeInstallmentsTotalDoesNotMatchGiftAmount"
    ...
    PLEDGEWITHIRREGULARSCHEDULEMUSTHAVEINSTALLMENTS = "PledgeWithIrregularScheduleMustHaveInstallments"
    PLEDGEWITHSINGLEFREQUENCYMUSTHAVEEXACTLYONEINSTALLMENT = "PledgeWithSingleFrequencyMustHaveExactlyOneInstallment"
    ...
    SUMOFAMOUNTAPPLIEDDOESNOTEQUALGIFTAMOUNT = "SumOfAmountAppliedDoesNotEqualGiftAmount"
    TRANSACTIONCAPTUREFAILEDWITHPROVIDEDTRANSACTIONID = "TransactionCaptureFailedWithProvidedTransactionId"
    TRANSACTIONDATEMUSTBEWITHINONEYEARTOPROCESSREFUND = "TransactionDateMustBeWithinOneYearToProcessRefund"
    TRANSACTIONDETAILSUPDATEFAILED = "TransactionDetailsUpdateFailed"
    TRANSACTIONGATEWAYIDMUSTBEBBMSTOPROCESSREFUND = "TransactionGatewayIdMustBeBBMSToProcessRefund"
    TRANSACTIONIDCOULDNOTBEFOUND = "TransactionIdCouldNotBeFound"
    TRANSACTIONRESULTCODEMUSTBEAPPROVEDTOPROCESSREFUND = "TransactionResultCodeMustBeApprovedToProcessRefund"
    ...
    UPDATEDGIFTAMOUNTLESSTHANAMOUNTSUBJECTTOVAT = "UpdatedGiftAmountLessThanAmountSubjectToVat"
    UPDATEDGIFTAMOUNTLESSTHANOPPORTUNITYAPPLIEDAMOUNT = "UpdatedGiftAmountLessThanOpportunityAppliedAmount"
    UPDATEDGIFTAMOUNTLESSTHANTOTALBENEFITSAMOUNT = "UpdatedGiftAmountLessThanTotalBenefitsAmount"
