...
from ..models.batch_gift_split_gift_aid_qualification_method import BatchGiftSplitGiftAidQualificationMethod
...
T = TypeVar("T", bound="BatchGiftSplit")


@_attrs_define
class BatchGiftSplit:
    """A split for a batch gift

    Attributes:
        batch_gift_id (None | str | Unset): ID of the batch gift to which this split belongs
        batch_id (None | str | Unset): ID of the batch to which this split belongs
        gift_aid_qualification_method (BatchGiftSplitGiftAidQualificationMethod | Unset): The gift aid qualification
            method for this batch gift split. Only applies if Gift Aid is enabled.
    ...
    gift_aid_qualification_method: BatchGiftSplitGiftAidQualificationMethod | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gift_aid_qualification_method: BatchGiftSplitGiftAidQualificationMethod | Unset
        if isinstance(_gift_aid_qualification_method, Unset):
            gift_aid_qualification_method = UNSET
        else:
            gift_aid_qualification_method = BatchGiftSplitGiftAidQualificationMethod(_gift_aid_qualification_method)
