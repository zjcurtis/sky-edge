...
if TYPE_CHECKING:
    from ..models.planned_gift_relationship_response import PlannedGiftRelationshipResponse
...
class PlannedGiftRelationshipListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for relationships_item_data in _relationships:
            relationships_item = PlannedGiftRelationshipResponse.from_dict(relationships_item_data)
