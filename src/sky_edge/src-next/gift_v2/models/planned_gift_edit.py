...
class PlannedGiftEdit:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if pooled_income_fund_total_units is not UNSET:
            field_dict["pooled_income_fund_total_units"] = pooled_income_fund_total_units
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        expected_maturity_year = _parse_expected_maturity_year(d.pop("expected_maturity_year", UNSET))
        ...
        pooled_income_fund_units = _parse_pooled_income_fund_units(d.pop("pooled_income_fund_units", UNSET))
        ...
        constituent_address_id = _parse_constituent_address_id(d.pop("constituent_address_id", UNSET))
        ...
        constituent_is_policy_owner = _parse_constituent_is_policy_owner(d.pop("constituent_is_policy_owner", UNSET))
        ...
        constituent_pays_premium = _parse_constituent_pays_premium(d.pop("constituent_pays_premium", UNSET))
        ...
        premium_is_fully_paid = _parse_premium_is_fully_paid(d.pop("premium_is_fully_paid", UNSET))
        ...
        premium_start_date = _parse_premium_start_date(d.pop("premium_start_date", UNSET))
        ...
        premium_day_of_month = _parse_premium_day_of_month(d.pop("premium_day_of_month", UNSET))
        ...
        constituent_is_beneficiary = _parse_constituent_is_beneficiary(d.pop("constituent_is_beneficiary", UNSET))
