...
from ..models.gift_tribute_add_acknowledgement_status import GiftTributeAddAcknowledgementStatus
...
class GiftTributeAdd:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tribute_acknowledgees(data: object) -> list[GiftTributeAcknowledgeeAdd] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for tribute_acknowledgees_type_0_item_data in _tribute_acknowledgees_type_0:
                    tribute_acknowledgees_type_0_item = GiftTributeAcknowledgeeAdd.from_dict(
        ...
        if isinstance(_acknowledge_status, Unset):
            ...
            acknowledge_status = GiftTributeAddAcknowledgementStatus(_acknowledge_status)
