...
from ..models.batch_gift_soft_credit_recognition_credit_type import BatchGiftSoftCreditRecognitionCreditType
...
T = TypeVar("T", bound="BatchGiftSoftCredit")


@_attrs_define
class BatchGiftSoftCredit:
    """A soft credit on a batch gift
    ...
    Attributes:
        ...
        credit_type (BatchGiftSoftCreditRecognitionCreditType | Unset): The type of recognition credit. Currently
    ...
    credit_type: BatchGiftSoftCreditRecognitionCreditType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credit_type: BatchGiftSoftCreditRecognitionCreditType | Unset
        if isinstance(_credit_type, Unset):
            credit_type = UNSET
        else:
            credit_type = BatchGiftSoftCreditRecognitionCreditType(_credit_type)
