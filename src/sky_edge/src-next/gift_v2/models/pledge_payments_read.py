...
class PledgePaymentsRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_pledge_payments(data: object) -> list[PledgePaymentRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for pledge_payments_type_0_item_data in _pledge_payments_type_0:
                    pledge_payments_type_0_item = PledgePaymentRead.from_dict(pledge_payments_type_0_item_data)
