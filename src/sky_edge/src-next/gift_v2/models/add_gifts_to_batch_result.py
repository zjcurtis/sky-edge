...
class AddGiftsToBatchResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.added_batch_gifts, Unset):
            ...
            for added_batch_gifts_type_0_item_data in self.added_batch_gifts:
                added_batch_gifts_type_0_item = added_batch_gifts_type_0_item_data.to_dict()
        ...
        if isinstance(self.gift_validation_errors, Unset):
            ...
            for gift_validation_errors_type_0_item_data in self.gift_validation_errors:
                gift_validation_errors_type_0_item = gift_validation_errors_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_added_batch_gifts(data: object) -> list[BatchGiftAdd] | None | Unset:
            ...
            try:
                ...
                for added_batch_gifts_type_0_item_data in _added_batch_gifts_type_0:
                    added_batch_gifts_type_0_item = BatchGiftAdd.from_dict(added_batch_gifts_type_0_item_data)
        ...
        def _parse_gift_validation_errors(data: object) -> list[GiftValidationError] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for gift_validation_errors_type_0_item_data in _gift_validation_errors_type_0:
                    gift_validation_errors_type_0_item = GiftValidationError.from_dict(
                        gift_validation_errors_type_0_item_data
                    )

                    gift_validation_errors_type_0.append(gift_validation_errors_type_0_item)
        ...
        gift_validation_errors = _parse_gift_validation_errors(d.pop("gift_validation_errors", UNSET))
