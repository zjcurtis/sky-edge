...
from ..models.pledge_installments_read_payment_method import PledgeInstallmentsReadPaymentMethod
from ..models.pledge_installments_read_schedule_frequency import PledgeInstallmentsReadScheduleFrequency
...
class PledgeInstallmentsRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_installments(data: object) -> list[PledgeInstallmentRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for installments_type_0_item_data in _installments_type_0:
                    installments_type_0_item = PledgeInstallmentRead.from_dict(installments_type_0_item_data)
        ...
        bbps_configuration_currency = _parse_bbps_configuration_currency(d.pop("bbps_configuration_currency", UNSET))
