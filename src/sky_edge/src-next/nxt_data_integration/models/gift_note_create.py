...
T = TypeVar("T", bound="GiftNoteCreate")


@_attrs_define
class GiftNoteCreate:
    """Contains the fields for creating a gift note.

    Attributes:
        gift_id (int): The record ID of the gift to which the note belongs; corresponds to ParentId in dbo.GiftNotepad.
        date (FuzzyDate):
