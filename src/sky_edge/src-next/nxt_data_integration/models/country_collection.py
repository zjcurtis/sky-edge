...
T = TypeVar("T", bound="CountryCollection")
...
class CountryCollection:
    ...
    Attributes:
        count (int | Unset):
        value (list[Country] | None | Unset):
    """

    count: int | Unset = UNSET
    value: list[Country] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> list[Country] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = Country.from_dict(value_type_0_item_data)
                ...
                pass
            return cast(list[Country] | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        country_collection = cls(
            count=count,
            value=value,
        )
