...
class CustomFieldCategoryCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        record_type = CustomFieldCategoryCreateCustomFieldCategoryRecordType(d.pop("record_type"))

        description = d.pop("description")

        data_type = CustomFieldCategoryCreateCustomFieldCategoryDataType(d.pop("data_type"))
