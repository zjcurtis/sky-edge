...
class Fund:
    ...
    Attributes:
        ...
        fund_category (None | str | Unset): The fund category.
        fund_type (None | str | Unset): The fund type.
        campaign (None | str | Unset): The campaign associated with the fund.
        default_appeal (None | str | Unset): The default appeal associated with the fund.
        id (int | Unset): The immutable system record ID of the fund.
    ...
    fund_id: str
    description: str
    fund_category: None | str | Unset = UNSET
    fund_type: None | str | Unset = UNSET
    campaign: None | str | Unset = UNSET
    default_appeal: None | str | Unset = UNSET
    id: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        fund_category: None | str | Unset
        if isinstance(self.fund_category, Unset):
            fund_category = UNSET
        else:
            fund_category = self.fund_category

        fund_type: None | str | Unset
        if isinstance(self.fund_type, Unset):
            fund_type = UNSET
        else:
        ...
        default_appeal: None | str | Unset
        if isinstance(self.default_appeal, Unset):
            default_appeal = UNSET
        else:
            default_appeal = self.default_appeal
        ...
        if fund_category is not UNSET:
            field_dict["fund_category"] = fund_category
        if fund_type is not UNSET:
            field_dict["fund_type"] = fund_type
        if campaign is not UNSET:
            field_dict["campaign"] = campaign
        if default_appeal is not UNSET:
            field_dict["default_appeal"] = default_appeal
        if id is not UNSET:
            field_dict["id"] = id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_fund_category(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        fund_category = _parse_fund_category(d.pop("fund_category", UNSET))

        def _parse_fund_type(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        fund_type = _parse_fund_type(d.pop("fund_type", UNSET))
        ...
        def _parse_default_appeal(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        default_appeal = _parse_default_appeal(d.pop("default_appeal", UNSET))
