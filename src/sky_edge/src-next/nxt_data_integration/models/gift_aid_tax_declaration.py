...
from ..models.gift_aid_tax_declaration_gift_aid_pays_tax import GiftAidTaxDeclarationGiftAidPaysTax
...
class GiftAidTaxDeclaration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tax_payer_status_id = _parse_tax_payer_status_id(d.pop("tax_payer_status_id", UNSET))
        ...
        declaration_indicator_id = _parse_declaration_indicator_id(d.pop("declaration_indicator_id", UNSET))
        ...
        declaration_source_id = _parse_declaration_source_id(d.pop("declaration_source_id", UNSET))
        ...
        if isinstance(_constituent_pays_tax, Unset):
            ...
            constituent_pays_tax = GiftAidTaxDeclarationGiftAidPaysTax(_constituent_pays_tax)
