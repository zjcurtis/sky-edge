...
from ..models.gift_aid_tax_declaration_create_gift_aid_pays_tax import GiftAidTaxDeclarationCreateGiftAidPaysTax
...
class GiftAidTaxDeclarationCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_constituent_pays_tax, Unset):
            ...
            constituent_pays_tax = GiftAidTaxDeclarationCreateGiftAidPaysTax(_constituent_pays_tax)
