...
T = TypeVar("T", bound="TributeCollection")
...
class TributeCollection:
    ...
    Attributes:
        count (int | Unset):
        value (list[Tribute] | None | Unset):
    """

    count: int | Unset = UNSET
    value: list[Tribute] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> list[Tribute] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = Tribute.from_dict(value_type_0_item_data)
                ...
                pass
            return cast(list[Tribute] | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        tribute_collection = cls(
            count=count,
            value=value,
        )

        return tribute_collection
