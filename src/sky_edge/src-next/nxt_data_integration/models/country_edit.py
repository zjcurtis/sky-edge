...
from ..models.country_edit_country_currency_placement import CountryEditCountryCurrencyPlacement
...
class CountryEdit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_currency_placement_id, Unset):
            ...
            currency_placement_id = CountryEditCountryCurrencyPlacement(_currency_placement_id)
