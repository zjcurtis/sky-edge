...
from ...models.tribute_acknowledgee_create import TributeAcknowledgeeCreate
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: TributeAcknowledgeeCreate | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/re/tribute/acknowledgee",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (TributeAcknowledgeeCreate | Unset):
