...
from ...models.constituent_appeal_create import ConstituentAppealCreate
...
def _get_kwargs(
    *,
    body: ConstituentAppealCreate | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/re/constitappeals",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (ConstituentAppealCreate | Unset): Contains the fields for creating a record in the
            dbo.CONSTITUENT_APPEAL table in Raiser's Edge.
