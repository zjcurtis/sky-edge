...
from ...models.name_format_configuration_field_create import NameFormatConfigurationFieldCreate
...
def _get_kwargs(
    *,
    body: NameFormatConfigurationFieldCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (NameFormatConfigurationFieldCreate | Unset): A name format configuration represents
