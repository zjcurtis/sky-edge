...
from ...models.gift_tribute_create import GiftTributeCreate
...
def _get_kwargs(
    *,
    body: GiftTributeCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (GiftTributeCreate | Unset): Represents the properties of a new Gift Tribute record
            in Raiser's Edge.
