...
from ...models.gift_aid_tax_declaration_create import GiftAidTaxDeclarationCreate
...
def _get_kwargs(
    *,
    body: GiftAidTaxDeclarationCreate | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/re/giftaid/taxdeclarations",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (GiftAidTaxDeclarationCreate | Unset): A record from the
            dbo.ConstituentTaxDeclaration table in Raiser's Edge.
