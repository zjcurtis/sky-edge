...
from ...models.phone_type_create import PhoneTypeCreate
...
def _get_kwargs(
    *,
    body: PhoneTypeCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PhoneTypeCreate | Unset): RE7 Phone type record base class from the dbo.TableEntries
