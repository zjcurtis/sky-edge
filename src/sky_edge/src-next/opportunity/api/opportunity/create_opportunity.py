...
from ...models.opportunity_add import OpportunityAdd
...
def _get_kwargs(
    *,
    body: OpportunityAdd | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (OpportunityAdd | Unset): Opportunities help you plan and track efforts to build
