...
from ...models.goal_add import GoalAdd
...
def _get_kwargs(
    *,
    body: GoalAdd | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/fundraisers/goals",
    }
...
def sync_detailed(
    *,
    ...
    """Fundraiser goal (Create)

     Creates a fundraiser goal.

    Args:
        body (GoalAdd | Unset): To help motivate fundraisers and track their effectiveness, your
