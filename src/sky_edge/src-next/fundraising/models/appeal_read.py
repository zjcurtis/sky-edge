...
class AppealRead:
    ...
    and events.
        ...
        Attributes:
            ...
            category (str | Unset): The category of the appeal. Available values are the entries in the <b>Appeal
                Category</b> table.
            date_added (datetime.datetime | Unset): The date when the appeal was created. Includes an offset from UTC in <a
                href="https://tools.ietf.org/html/rfc3339">ISO-8601 format: </a><i>1969-11-21T10:29:43-04:00</i>.
            date_modified (datetime.datetime | Unset): The date when the appeal was last modified. Includes an offset from
                UTC in <a href="https://tools.ietf.org/html/rfc3339">ISO-8601 format: </a><i>1969-11-21T10:29:43-04:00</i>.
            description (str | Unset): The display name of the appeal.
            end_date (datetime.datetime | Unset): The end date of the appeal. Uses <a
            ...
            inactive (bool | Unset): This computed field indicates that the appeal is active if the current date is after
                any <code>start_date</code> and before any <code>end_date</code>.
            lookup_id (str | Unset): The user-defined identifier for the appeal.
            start_date (datetime.datetime | Unset): The start date of the appeal. Uses <a
