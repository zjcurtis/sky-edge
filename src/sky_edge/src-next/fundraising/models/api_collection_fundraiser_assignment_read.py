...
T = TypeVar("T", bound="ApiCollectionFundraiserAssignmentRead")


@_attrs_define
class ApiCollectionFundraiserAssignmentRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_collection_fundraiser_assignment_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_fundraiser_assignment_read.additional_properties = d
        return api_collection_fundraiser_assignment_read
