...
T = TypeVar("T", bound="VolunteerSkillAdd")


@_attrs_define
class VolunteerSkillAdd:
    """Represents a request to add a skill or experience for a volunteer

    Attributes:
        constituent_id (str): The parent constituent's immutable system record ID.
        skill_description (str): Gets or sets the skill description
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        skill_description = d.pop("skill_description")
