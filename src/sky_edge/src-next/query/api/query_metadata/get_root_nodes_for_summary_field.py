...
from ...models.get_root_nodes_for_summary_field_module import GetRootNodesForSummaryFieldModule
from ...models.get_root_nodes_for_summary_field_product import GetRootNodesForSummaryFieldProduct
...
def _get_kwargs(
    ...
    *,
    product: GetRootNodesForSummaryFieldProduct,
    module: GetRootNodesForSummaryFieldModule,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/summaryfields/{summary_field_id}/availablefields".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Available fields tree for summary field (Root)

     Gets the list of nodes at the root of the available fields tree for summary field.
