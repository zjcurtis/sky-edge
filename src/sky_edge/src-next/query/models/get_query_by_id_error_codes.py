...
T = TypeVar("T", bound="GetQueryByIdErrorCodes")


@_attrs_define
class GetQueryByIdErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:view-not-supported</td><td>Viewing this query is not yet
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_query_by_id_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_query_by_id_error_codes.additional_properties = d
        return get_query_by_id_error_codes
