...
class GetSummaryFieldDefaultFiltersResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_filters(data: object) -> list[FilterFieldRead] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for default_filters_type_0_item_data in _default_filters_type_0:
                    default_filters_type_0_item = FilterFieldRead.from_dict(default_filters_type_0_item_data)
