...
if TYPE_CHECKING:
    from ..models.filter_field_read_filter_values_type_0_item import FilterFieldReadFilterValuesType0Item
    from ..models.query_field import QueryField


T = TypeVar("T", bound="FilterFieldRead")


@_attrs_define
class FilterFieldRead:
    ...
    Attributes:
        ...
        filter_values (list[FilterFieldReadFilterValuesType0Item] | None | Unset): Values for the filter.
    ...
    filter_values: list[FilterFieldReadFilterValuesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_filter_values(data: object) -> list[FilterFieldReadFilterValuesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for filter_values_type_0_item_data in _filter_values_type_0:
                    filter_values_type_0_item = FilterFieldReadFilterValuesType0Item.from_dict(
                ...
                pass
            return cast(list[FilterFieldReadFilterValuesType0Item] | None | Unset, data)
