...
class QueryRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_select_fields(data: object) -> list[SelectFieldRead] | None | Unset:
            ...
            try:
                ...
                for select_fields_type_0_item_data in _select_fields_type_0:
                    select_fields_type_0_item = SelectFieldRead.from_dict(select_fields_type_0_item_data)
        ...
        def _parse_filter_fields(data: object) -> list[FilterFieldRead] | None | Unset:
            ...
            try:
                ...
                for filter_fields_type_0_item_data in _filter_fields_type_0:
                    filter_fields_type_0_item = FilterFieldRead.from_dict(filter_fields_type_0_item_data)
        ...
        def _parse_sort_fields(data: object) -> list[SortFieldRead] | None | Unset:
            ...
            try:
                ...
                for sort_fields_type_0_item_data in _sort_fields_type_0:
                    sort_fields_type_0_item = SortFieldRead.from_dict(sort_fields_type_0_item_data)
        ...
        if isinstance(_merged_query_details, Unset):
            ...
            merged_query_details = MergedQueryDetailsRead.from_dict(_merged_query_details)
        ...
        def _parse_summary_fields(data: object) -> list[SummaryFieldRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for summary_fields_type_0_item_data in _summary_fields_type_0:
                    summary_fields_type_0_item = SummaryFieldRead.from_dict(summary_fields_type_0_item_data)
        ...
        select_from_query_name = _parse_select_from_query_name(d.pop("select_from_query_name", UNSET))
