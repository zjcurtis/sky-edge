...
T = TypeVar("T", bound="RefreshStaticQueryErrorCodes")


@_attrs_define
class RefreshStaticQueryErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            not currently supported. Support will be available in a future release.</td></tr><tr><td>urn:blackbaud:merge-
            query-component-id-not-valid</td><td>One of the queries for this merge query with the ID of {0} does not
            exist.</td></tr><tr><td>urn:blackbaud:output-limit-not-supported</td><td>Output limit not supported for static
            query refresh.</td></tr><tr><td>urn:blackbaud:static-query-required</td><td>{0} is only valid for a static
            query.</td></tr><tr><td>urn:blackbaud:select-from-query-loop-detected</td><td>This query results in an invalid
            select from query loop.</td></tr><tr><td>urn:blackbaud:invalid-query-for-static-query-refresh</td><td>Cannot
            perform a static query refresh for a {0}.</td></tr><tr><td>urn:blackbaud:ask-field-values-required</td><td>The
            supplied number of ask fields ({0}) does not match the number of ask fields on the query
            ({1}).</td></tr><tr><td>urn:blackbaud:ask-field-mismatch</td><td>ask_fields[{0}].query_field_id {1} does not
            match the query field ID of the corresponding query ask field ({2}).</td></tr><tr><td>urn:blackbaud:invalid-
            query-field-id</td><td>Query field {0} referenced at {1} does not exist.</td></tr><tr><td>urn:blackbaud:invalid-
            unique-id</td><td>Unique ID {0} is not valid for query field {1} referenced at {2}.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        refresh_static_query_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        refresh_static_query_error_codes.additional_properties = d
        return refresh_static_query_error_codes
