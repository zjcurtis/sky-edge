...
class GetQueryTypesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_query_types(data: object) -> list[QueryType] | None | Unset:
            ...
            try:
                ...
                for query_types_type_0_item_data in _query_types_type_0:
                    query_types_type_0_item = QueryType.from_dict(query_types_type_0_item_data)
        ...
        default_query_type_id = _parse_default_query_type_id(d.pop("default_query_type_id", UNSET))
