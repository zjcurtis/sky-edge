...
T = TypeVar("T", bound="SummaryFieldRead")


@_attrs_define
class SummaryFieldRead:
    ...
    summary_instance.
        ...
        Attributes:
            ...
            filter_fields (list[FilterFieldRead] | None | Unset): The filters on this summary field
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary_field_read = cls(
            query_field_id=query_field_id,
            summary_instance=summary_instance,
            filter_fields=filter_fields,
        )

        return summary_field_read
