...
T = TypeVar("T", bound="GetQueryListV2ErrorCodes")


@_attrs_define
class GetQueryListV2ErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:invalid-value</td><td>'{0}' is not a valid value for
            {1}.</td></tr><tr><td>urn:blackbaud:invalid-added-by-id</td><td>The provided value for added_by must be an
            integer.</td></tr><tr><td>urn:blackbaud:invalid-date-value</td><td>The provided date value must be within the
            range of 1753 to 9999.</td></tr><tr><td>urn:blackbaud:fe-does-not-support-single-row-result-layout</td><td>The
            Financial Edge does not currently support the single-row result layout.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_query_list_v2_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_query_list_v2_error_codes.additional_properties = d
        return get_query_list_v2_error_codes
