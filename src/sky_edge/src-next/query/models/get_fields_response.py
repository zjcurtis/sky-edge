...
T = TypeVar("T", bound="GetFieldsResponse")


@_attrs_define
class GetFieldsResponse:
    """Response model for GetRootNodesForQueryType and GetChildrenOfQueryNode
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_fields_response = cls(
            nodes=nodes,
            fields=fields,
        )

        return get_fields_response
