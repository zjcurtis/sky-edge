...
class AvailableFieldsSearchResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.available_fields, Unset):
            ...
            for available_fields_type_0_item_data in self.available_fields:
                available_fields_type_0_item = available_fields_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_available_fields(data: object) -> list[AvailableFieldsSearchResult] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for available_fields_type_0_item_data in _available_fields_type_0:
                    available_fields_type_0_item = AvailableFieldsSearchResult.from_dict(
