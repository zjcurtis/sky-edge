...
class AdvancedProcessingOptions:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        use_alternate_sql_multiple_attributes = self.use_alternate_sql_multiple_attributes

        field_dict: dict[str, Any] = {}

        field_dict.update({})
        if use_alternate_sql_code_table_fields is not UNSET:
            field_dict["use_alternate_sql_code_table_fields"] = use_alternate_sql_code_table_fields
        if use_alternate_sql_multiple_attributes is not UNSET:
            field_dict["use_alternate_sql_multiple_attributes"] = use_alternate_sql_multiple_attributes
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        use_alternate_sql_code_table_fields = d.pop("use_alternate_sql_code_table_fields", UNSET)

        use_alternate_sql_multiple_attributes = d.pop("use_alternate_sql_multiple_attributes", UNSET)
