...
T = TypeVar("T", bound="QueryEditErrorCodes")


@_attrs_define
class QueryEditErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:id-mismatch</td><td>The ID specified on the body does not match the ID of the
            URL.</td></tr><tr><td>urn:blackbaud:invalid-type-change</td><td>Invalid type
            change.</td></tr><tr><td>urn:blackbaud:select-from-query-cannot-self-reference</td><td>Select from query ID
            cannot reference the query itself.</td></tr><tr><td>urn:blackbaud:query-not-created-by-query</td><td>This query
            cannot be edited because it was not created by query.</td></tr><tr><td>urn:blackbaud:invalid-type-
            id</td><td>Invalid query type.</td></tr><tr><td>urn:blackbaud:property-not-supported</td><td>The property '{0}'
            is not yet supported on this operation.</td></tr><tr><td>urn:blackbaud:query-name-must-be-unique</td><td>Query
            name must be unique.</td></tr><tr><td>urn:blackbaud:invalid-category</td><td>Invalid query
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_edit_error_codes.additional_properties = d
        return query_edit_error_codes
