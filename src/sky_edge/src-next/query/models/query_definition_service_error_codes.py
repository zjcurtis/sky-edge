...
T = TypeVar("T", bound="QueryDefinitionServiceErrorCodes")


@_attrs_define
class QueryDefinitionServiceErrorCodes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_definition_service_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        query_definition_service_error_codes.additional_properties = d
        return query_definition_service_error_codes
