...
from ..models.edit_gift_tax_gift_aid_qualification_method import EditGiftTaxGiftAidQualificationMethod
...
class EditGiftTax:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_gift_aid_q_method, Unset):
            ...
            gift_aid_q_method = EditGiftTaxGiftAidQualificationMethod(_gift_aid_q_method)
