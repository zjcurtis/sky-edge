...
from ..models.tax_declaration_update_constituent_pay_tax import TaxDeclarationUpdateConstituentPayTax
...
T = TypeVar("T", bound="TaxDeclarationUpdate")


@_attrs_define
class TaxDeclarationUpdate:
    """Tax declaration edit model
    ...
    Attributes:
        ...
        constituent_pays_tax (TaxDeclarationUpdateConstituentPayTax | Unset): Indicates status of the Constituent pays
            tax.
    ...
    constituent_pays_tax: TaxDeclarationUpdateConstituentPayTax | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        constituent_pays_tax: TaxDeclarationUpdateConstituentPayTax | Unset
        if isinstance(_constituent_pays_tax, Unset):
            constituent_pays_tax = UNSET
        else:
            constituent_pays_tax = TaxDeclarationUpdateConstituentPayTax(_constituent_pays_tax)
