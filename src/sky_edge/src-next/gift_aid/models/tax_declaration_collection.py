...
class TaxDeclarationCollection:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.tax_declarations, Unset):
            ...
            for tax_declarations_type_0_item_data in self.tax_declarations:
                tax_declarations_type_0_item = tax_declarations_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tax_declarations(data: object) -> list[TaxDeclaration] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tax_declarations_type_0_item_data in _tax_declarations_type_0:
                    tax_declarations_type_0_item = TaxDeclaration.from_dict(tax_declarations_type_0_item_data)
