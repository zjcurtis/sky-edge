...
from ..models.tax_declaration_add_constituent_pay_tax import TaxDeclarationAddConstituentPayTax
...
class TaxDeclarationAdd:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_constituent_pays_tax, Unset):
            ...
            constituent_pays_tax = TaxDeclarationAddConstituentPayTax(_constituent_pays_tax)
