...
class ConsentChannelConfigurationRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_categories(data: object) -> list[ConsentChannelCategoryRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for categories_type_0_item_data in _categories_type_0:
                    categories_type_0_item = ConsentChannelCategoryRead.from_dict(categories_type_0_item_data)
