...
T = TypeVar("T", bound="EditConsentChannel400ResponseTypes")


@_attrs_define
class EditConsentChannel400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            channel</td><td>The channel is invalid.</td></tr><tr><td>urn:blackbaud:mandatory-consent-channel</td><td>The
            given channel may not be edited.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_consent_channel_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        edit_consent_channel_400_response_types.additional_properties = d
        return edit_consent_channel_400_response_types
