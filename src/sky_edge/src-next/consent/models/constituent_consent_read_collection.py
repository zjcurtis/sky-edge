...
class ConstituentConsentReadCollection:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.constituent_consents, Unset):
            ...
            for constituent_consents_type_0_item_data in self.constituent_consents:
                constituent_consents_type_0_item = constituent_consents_type_0_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_constituent_consents(data: object) -> list[ConstituentConsentRead] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for constituent_consents_type_0_item_data in _constituent_consents_type_0:
        ...
        constituent_consents = _parse_constituent_consents(d.pop("constituent_consents", UNSET))
