...
T = TypeVar("T", bound="AddChannelCategory400ResponseTypes")


@_attrs_define
class AddChannelCategory400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            channel</td><td>The channel is invalid.</td></tr><tr><td>urn:blackbaud:invalid-consent-response</td><td>One or
            more solicit code assignments include an invalid consent response.</td></tr><tr><td>urn:blackbaud:inactive-
            category</td><td>The category is inactive.</td></tr><tr><td>urn:blackbaud:invalid-category</td><td>The consent
            category is invalid.</td></tr><tr><td>urn:blackbaud:inactive-solicit-code</td><td>One or more solicit code
            assignments include an inactive solicit code.</td></tr><tr><td>urn:blackbaud:invalid-solicit-code</td><td>One or
            more solicit code assignments include an invalid solicit code.</td></tr><tr><td>urn:blackbaud:consent-channel-
            category-already-exists</td><td>The consent channel category already
            exists.</td></tr><tr><td>urn:blackbaud:invalid-add-remove</td><td>One or more solicit code assignments include
            an invalid add/remove.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_channel_category_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        add_channel_category_400_response_types.additional_properties = d
        return add_channel_category_400_response_types
