...
T = TypeVar("T", bound="CreateConsentsMultipleConstituents400ResponseTypes")


@_attrs_define
class CreateConsentsMultipleConstituents400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            id</td><td>The constituent identifier is invalid.</td></tr><tr><td>urn:blackbaud:invalid-channel</td><td>The
            channel is invalid.</td></tr><tr><td>urn:blackbaud:invalid-number-of-requests</td><td>A single bulk request must
            include between 1 and 500 requests.</td></tr><tr><td>urn:blackbaud:invalid-consent-response</td><td>One or more
            consent responses are invalid.</td></tr><tr><td>urn:blackbaud:inactive-category</td><td>The category is
            inactive.</td></tr><tr><td>urn:blackbaud:invalid-category</td><td>The consent category is
            invalid.</td></tr><tr><td>urn:blackbaud:inactive-source</td><td>The consent source is
            inactive.</td></tr><tr><td>urn:blackbaud:invalid-source</td><td>The consent source is invalid.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_consents_multiple_constituents_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_consents_multiple_constituents_400_response_types.additional_properties = d
        return create_consents_multiple_constituents_400_response_types
