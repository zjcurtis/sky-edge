...
T = TypeVar("T", bound="GetConstituentConsents400ResponseTypes")


@_attrs_define
class GetConstituentConsents400ResponseTypes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_constituent_consents_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_constituent_consents_400_response_types.additional_properties = d
        return get_constituent_consents_400_response_types
