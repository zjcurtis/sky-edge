...
from ..models.create_consent_request_consent_response import CreateConsentRequestConsentResponse
...
class CreateConsentRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        consent_response = CreateConsentRequestConsentResponse(d.pop("consent_response"))
