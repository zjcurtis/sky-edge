...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | CreateConsentsSingleConstituent400ResponseTypes | IdentifierCollection | ProblemDetails | None:
    ...
    if response.status_code == 400:
        response_400 = CreateConsentsSingleConstituent400ResponseTypes.from_dict(response.json())
