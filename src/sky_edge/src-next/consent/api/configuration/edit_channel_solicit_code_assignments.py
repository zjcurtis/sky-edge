...
from ...models.edit_channel_solicit_code_assignments_channel import EditChannelSolicitCodeAssignmentsChannel
from ...models.edit_solicit_code_assignments_request import EditSolicitCodeAssignmentsRequest
from ...models.problem_details import ProblemDetails
from ...models.update_solicit_code_assignments_400_response_types import UpdateSolicitCodeAssignments400ResponseTypes
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = UpdateSolicitCodeAssignments400ResponseTypes.from_dict(response.json())
