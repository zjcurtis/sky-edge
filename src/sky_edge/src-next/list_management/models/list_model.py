...
class ListModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created_by_user_name = _parse_created_by_user_name(d.pop("created_by_user_name", UNSET))
        ...
        last_changed_by_user_id = _parse_last_changed_by_user_id(d.pop("last_changed_by_user_id", UNSET))
        ...
        last_changed_by_user_name = _parse_last_changed_by_user_name(d.pop("last_changed_by_user_name", UNSET))
        ...
        def _parse_record_count_as_of_date(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        record_count_as_of_date = _parse_record_count_as_of_date(d.pop("record_count_as_of_date", UNSET))
