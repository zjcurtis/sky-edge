...
class EditListRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_if_match_last_changed_date(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        if_match_last_changed_date = _parse_if_match_last_changed_date(d.pop("if_match_last_changed_date", UNSET))
