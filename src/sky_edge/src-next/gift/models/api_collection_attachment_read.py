...
T = TypeVar("T", bound="ApiCollectionAttachmentRead")


@_attrs_define
class ApiCollectionAttachmentRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_collection_attachment_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_attachment_read.additional_properties = d
        return api_collection_attachment_read
