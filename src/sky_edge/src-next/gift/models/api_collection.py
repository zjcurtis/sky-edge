...
if TYPE_CHECKING:
    from ..models.api_collection_value_item import ApiCollectionValueItem


T = TypeVar("T", bound="ApiCollection")
...
class ApiCollection:
    ...
    large data sets. This entity includes helpful metadata and properties to paginate and iterate through the data.
        ...
        Attributes:
            ...
            value (list[ApiCollectionValueItem] | Unset): The result set of items after applying any request parameters. To
                facilitate paging, this may be a subset of all available items.
    """

    count: int | Unset = UNSET
    next_link: str | Unset = UNSET
    value: list[ApiCollectionValueItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = ApiCollectionValueItem.from_dict(value_item_data)
        ...
        api_collection.additional_properties = d
