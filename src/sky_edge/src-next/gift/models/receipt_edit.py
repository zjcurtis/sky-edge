...
T = TypeVar("T", bound="ReceiptEdit")


@_attrs_define
class ReceiptEdit:
    """An object that represents the gift receipt to edit.
    To help donors track their giving for tax purposes, your organization should provide gift receipts.
        ...
        Attributes:
            ...
            status (str | Unset): The receipt status of the gift. Available values are: <i>RECEIPTED</i>,
                ...
                When <code>receipt_status</code> is set to <i>NEEDSRECEIPT</i> or <i>DONOTRECEIPT</i>, <code>receipt_date</code>
                should be null.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        receipt_edit.additional_properties = d
        return receipt_edit
