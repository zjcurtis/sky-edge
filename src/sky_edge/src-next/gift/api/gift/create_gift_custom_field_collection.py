...
def _get_kwargs(
    gift_id: str,
    *,
    body: CustomFieldAdd | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/gifts/{gift_id}/customfieldcollection".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Gift custom field collection (Create)

     Creates a gift custom field.

    Args:
        gift_id (str):
        body (CustomFieldAdd | Unset): While records provide many fields to track information,
