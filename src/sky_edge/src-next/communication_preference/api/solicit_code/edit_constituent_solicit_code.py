...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/constituentsolicitcodes/{constituent_solicit_code_id}".format(
            constituent_solicit_code_id=quote(str(constituent_solicit_code_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Constituent solicit code (Edit)

     Edits a constituent solicit code.
