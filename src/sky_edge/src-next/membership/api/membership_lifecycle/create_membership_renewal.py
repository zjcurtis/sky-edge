...
from ...models.membership_renew import MembershipRenew
...
def _get_kwargs(
    ...
    *,
    body: MembershipRenew | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/memberships/{member_junction_id}/renew".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Renew a membership (PREVIEW)

     Renews a membership. Supports renewal at the same level, upgrade, or downgrade.

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        member_junction_id (str):
        body (MembershipRenew | Unset): Membership renew request model
