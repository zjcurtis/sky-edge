...
from ...models.membership_rejoin import MembershipRejoin
...
def _get_kwargs(
    ...
    *,
    body: MembershipRejoin | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/memberships/{member_junction_id}/rejoin".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Rejoin a dropped membership (PREVIEW)

     Rejoins a dropped membership. Only Dropped memberships can be rejoined.

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        member_junction_id (str):
        body (MembershipRejoin | Unset): Membership rejoin request model
