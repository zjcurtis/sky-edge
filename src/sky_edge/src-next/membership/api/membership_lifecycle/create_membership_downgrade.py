...
from ...models.membership_downgrade import MembershipDowngrade
...
def _get_kwargs(
    ...
    *,
    body: MembershipDowngrade | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/memberships/{member_junction_id}/downgrade".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Downgrade a membership during cycle (PREVIEW)

     Downgrades a membership during cycle. Only Active or Lapsed memberships can be downgraded.

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        member_junction_id (str):
        body (MembershipDowngrade | Unset): Membership downgrade request model for during-cycle
            downgrades
