...
from ...models.get_membership_benefits_by_member_junction_id_async_sort_direction import (
...
def _get_kwargs(
    ...
    *,
    sort_direction: GetMembershipBenefitsByMemberJunctionIdAsyncSortDirection
    | Unset = GetMembershipBenefitsByMemberJunctionIdAsyncSortDirection.ASCENDING,
    limit: int | Unset = 500,
    offset: int | Unset = 0,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/memberships/{member_junction_id}/benefits".format(
...
) -> Any | BadRequest400ResponseTypes | MembershipBenefitCollection | ProblemDetails | None:
...
def sync_detailed(
    ...
    *,
    ...
    """Get membership benefits list

     Returns the membership benefits list.

    Args:
        member_junction_id (str):
        sort_direction (GetMembershipBenefitsByMemberJunctionIdAsyncSortDirection | Unset):
            Default: GetMembershipBenefitsByMemberJunctionIdAsyncSortDirection.ASCENDING.
