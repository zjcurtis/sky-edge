...
from ...models.renewal_notice_information_collection import RenewalNoticeInformationCollection
...
) -> Any | BadRequest400ResponseTypes | ProblemDetails | RenewalNoticeInformationCollection | None:
