...
def _get_kwargs(
    ...
    *,
    body: LinkGiftCreate | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/memberships/{member_junction_id}/addlinktogift".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Add a linked gift for membership (PREVIEW)
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Args:
        member_junction_id (str):
        body (LinkGiftCreate | Unset): Create memberships link to gift
