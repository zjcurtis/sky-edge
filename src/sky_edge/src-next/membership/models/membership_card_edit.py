...
from ..models.membership_card_edit_membership_card_expires import MembershipCardEditMembershipCardExpires
from ..models.membership_card_edit_membership_cards_address_to_print import (
    MembershipCardEditMembershipCardsAddressToPrint,
)
from ..models.membership_card_edit_membership_cards_status import MembershipCardEditMembershipCardsStatus
...
class MembershipCardEdit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_address_to_print, Unset):
            ...
            address_to_print = MembershipCardEditMembershipCardsAddressToPrint(_address_to_print)
