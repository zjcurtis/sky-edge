...
class CustomFieldCategoryValuesCollection:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_field_category_values(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
        ...
        custom_field_category_values = _parse_custom_field_category_values(d.pop("custom_field_category_values", UNSET))
