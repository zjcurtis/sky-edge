...
from ..models.membership_summary_membership_standing import MembershipSummaryMembershipStanding
...
class MembershipSummary:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if primary_member_constituent_name is not UNSET:
            field_dict["primary_member_constituent_name"] = primary_member_constituent_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_membership_id = _parse_custom_membership_id(d.pop("custom_membership_id", UNSET))
