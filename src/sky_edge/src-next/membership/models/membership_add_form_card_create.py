...
class MembershipAddFormCardCreate:
    ...
    address_to_print: MembershipAddFormCardCreateMembershipCardsAddressToPrint | Unset = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_card_expires, Unset):
            ...
            card_expires = MembershipAddFormCardCreateMembershipCardExpires(_card_expires)
        ...
        if isinstance(_address_to_print, Unset):
            ...
            address_to_print = MembershipAddFormCardCreateMembershipCardsAddressToPrint(_address_to_print)
