...
from ..models.custom_field_category_details_custom_field_type import CustomFieldCategoryDetailsCustomFieldType
...
class CustomFieldCategoryDetails:
    """Membership custom field category Model

    Attributes:
        name (None | str | Unset): The category name.
        type_ (CustomFieldCategoryDetailsCustomFieldType | Unset): The type of value of category.
    ...
    type_: CustomFieldCategoryDetailsCustomFieldType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: CustomFieldCategoryDetailsCustomFieldType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = CustomFieldCategoryDetailsCustomFieldType(_type_)
