...
class MembershipCardsCollection:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_membership_cards(data: object) -> list[MembershipCard] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for membership_cards_type_0_item_data in _membership_cards_type_0:
                    membership_cards_type_0_item = MembershipCard.from_dict(membership_cards_type_0_item_data)
