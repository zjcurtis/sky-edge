...
T = TypeVar("T", bound="GetJob400ResponseTypes")


@_attrs_define
class GetJob400ResponseTypes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_job_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_job_400_response_types.additional_properties = d
        return get_job_400_response_types
