...
T = TypeVar("T", bound="CreateJob400ResponseTypes")


@_attrs_define
class CreateJob400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:unsupported-
            import-file-type</td><td>UnsupportedImportFileType</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_job_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_job_400_response_types.additional_properties = d
        return create_job_400_response_types
