...
T = TypeVar("T", bound="GetJobUploadUri400ResponseTypes")


@_attrs_define
class GetJobUploadUri400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            value</td><td>InvalidEmptyValue</td></tr><tr><td>urn:blackbaud:job-not-in-pending-
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_job_upload_uri_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_job_upload_uri_400_response_types.additional_properties = d
        return get_job_upload_uri_400_response_types
