...
T = TypeVar("T", bound="EditJob400ResponseTypes")


@_attrs_define
class EditJob400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            value</td><td>InvalidEmptyValue</td></tr><tr><td>urn:blackbaud:unsupported-import-file-
            type</td><td>UnsupportedImportFileType</td></tr><tr><td>urn:blackbaud:job-not-in-pending-
            state</td><td>JobNotInPendingState</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_job_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        edit_job_400_response_types.additional_properties = d
        return edit_job_400_response_types
