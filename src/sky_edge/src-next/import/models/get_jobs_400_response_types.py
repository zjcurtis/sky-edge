...
T = TypeVar("T", bound="GetJobs400ResponseTypes")


@_attrs_define
class GetJobs400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            value</td><td>InvalidEmptyValue</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_jobs_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_jobs_400_response_types.additional_properties = d
        return get_jobs_400_response_types
