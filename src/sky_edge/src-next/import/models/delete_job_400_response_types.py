...
T = TypeVar("T", bound="DeleteJob400ResponseTypes")


@_attrs_define
class DeleteJob400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            value</td><td>InvalidEmptyValue</td></tr><tr><td>urn:blackbaud:cannot-delete-running-
            job</td><td>CannotDeleteRunningJob</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_job_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        delete_job_400_response_types.additional_properties = d
        return delete_job_400_response_types
