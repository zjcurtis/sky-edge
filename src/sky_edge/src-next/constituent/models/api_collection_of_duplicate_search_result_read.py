...
if TYPE_CHECKING:
    from ..models.duplicate_search_result_read import DuplicateSearchResultRead


T = TypeVar("T", bound="ApiCollectionOfDuplicateSearchResultRead")


@_attrs_define
class ApiCollectionOfDuplicateSearchResultRead:
    ...
    large data sets. This entity includes helpful metadata and properties to paginate and iterate through the data.
        ...
        Attributes:
            ...
            value (list[DuplicateSearchResultRead] | Unset): The set of items included in the response. This may be a subset
                of the items in the collection.
    """

    count: int | Unset = UNSET
    next_link: str | Unset = UNSET
    value: list[DuplicateSearchResultRead] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = DuplicateSearchResultRead.from_dict(value_item_data)

                value.append(value_item)

        api_collection_of_duplicate_search_result_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_of_duplicate_search_result_read.additional_properties = d
        return api_collection_of_duplicate_search_result_read
