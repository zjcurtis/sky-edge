...
if TYPE_CHECKING:
    from ..models.constituent_fundraiser_read import ConstituentFundraiserRead


T = TypeVar("T", bound="ApiCollectionOfConstituentFundraiserRead")


@_attrs_define
class ApiCollectionOfConstituentFundraiserRead:
    ...
    large data sets. This entity includes helpful metadata and properties to paginate and iterate through the data.
        ...
        Attributes:
            ...
            value (list[ConstituentFundraiserRead] | Unset): The set of items included in the response. This may be a subset
                of the items in the collection.
    """

    count: int | Unset = UNSET
    next_link: str | Unset = UNSET
    value: list[ConstituentFundraiserRead] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = ConstituentFundraiserRead.from_dict(value_item_data)

                value.append(value_item)

        api_collection_of_constituent_fundraiser_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_of_constituent_fundraiser_read.additional_properties = d
        return api_collection_of_constituent_fundraiser_read
