...
class NoteAdd:
    ...
    relationships and track lessons learned for more effective fundraising.
        ...
        Attributes:
            constituent_id (str): The immutable system record ID of the constituent associated with the note.
            ...
            type_ (str): The note type. Available values are the entries in the <a href="https://developer.sky.blackbaud.com
                /docs/services/56b76470069a0509c8f1c5b3/operations/ListNoteTypes"><b>Notepad Types</b></a> table.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        note_add.additional_properties = d
        return note_add
