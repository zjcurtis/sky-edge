...
T = TypeVar("T", bound="ConstituentCodeEdit")


@_attrs_define
class ConstituentCodeEdit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        constituent_code_edit = cls(
            end=end,
            start=start,
            sequence=sequence,
        )

        constituent_code_edit.additional_properties = d
        return constituent_code_edit
