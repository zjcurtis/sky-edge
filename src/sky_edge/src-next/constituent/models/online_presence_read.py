...
T = TypeVar("T", bound="OnlinePresenceRead")


@_attrs_define
class OnlinePresenceRead:
    ...
    gaining more information about the constituent.
        ...
        Attributes:
            id (str | Unset): The immutable system record ID of the online presence.
            address (str | Unset): The web address for the online presence.
            constituent_id (str | Unset): The immutable system record ID of the constituent associated with the online
                presence.
            date_added (datetime.datetime | Unset): The date when the online presence was created. Includes an offset from
                UTC in <a href="https://tools.ietf.org/html/rfc3339">ISO-8601 format: </a><i>1969-11-21T10:29:43-04:00</i>.
            date_modified (datetime.datetime | Unset): The date when the online presence was last modified. Includes an
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        online_presence_read.additional_properties = d
        return online_presence_read
