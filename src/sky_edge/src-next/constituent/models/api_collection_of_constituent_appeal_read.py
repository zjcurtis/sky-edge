...
if TYPE_CHECKING:
    from ..models.constituent_appeal_read import ConstituentAppealRead


T = TypeVar("T", bound="ApiCollectionOfConstituentAppealRead")


@_attrs_define
class ApiCollectionOfConstituentAppealRead:
    ...
    large data sets. This entity includes helpful metadata and properties to paginate and iterate through the data.
        ...
        Attributes:
            ...
            value (list[ConstituentAppealRead] | Unset): The set of items included in the response. This may be a subset of
                the items in the collection.
    """

    count: int | Unset = UNSET
    next_link: str | Unset = UNSET
    value: list[ConstituentAppealRead] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = ConstituentAppealRead.from_dict(value_item_data)

                value.append(value_item)

        api_collection_of_constituent_appeal_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_of_constituent_appeal_read.additional_properties = d
        return api_collection_of_constituent_appeal_read
