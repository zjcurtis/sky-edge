...
@_attrs_define
class AddressAdd:
    """Addresses store information about constituent residences and other addresses along with information about where or
    whether to send mail.

        Attributes:
            constituent_id (str): The immutable system record ID of the constituent associated with the address.
            ...
            city (str | Unset): The city of the address.  Do not use in combination with the <code>suburb</code> property.
                Character limit: 50.
            country (str | Unset): The country of the address, can be the country's ID, name, or abbreviation.
            ...
            suburb (str | Unset): The suburb of the address. Do not use in combination with the <code>city</code> property.
            ...
            region (str | Unset): The region for the address.
    """
