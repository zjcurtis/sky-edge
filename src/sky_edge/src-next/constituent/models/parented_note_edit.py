...
T = TypeVar("T", bound="ParentedNoteEdit")


@_attrs_define
class ParentedNoteEdit:
    ...
    relationships and track lessons learned for more effective fundraising.
        ...
        Attributes:
            ...
            type_ (str | Unset): The note type. Available values are the entries in the <a href="https://developer.sky.black
                baud.com/docs/services/56b76470069a0509c8f1c5b3/operations/codetables_gettableentriesbyid">Code table API using
                the <b>Notepad Types</b> table ID</a>. This property cannot be set to null.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parented_note_edit.additional_properties = d
        return parented_note_edit
