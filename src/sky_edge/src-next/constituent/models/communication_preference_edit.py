...
T = TypeVar("T", bound="CommunicationPreferenceEdit")


@_attrs_define
class CommunicationPreferenceEdit:
    ...
    restrictions about when to reach out to constituents and how to tailor communications to honor their requests.
        ...
        Attributes:
            ...
            solicit_code (str | Unset): Communication instructions and/or restrictions for a constituent. Available values
                ...
                tions/ListCommunicationPreferences"><b>Solicit Code</b></a> table. This property cannot be set to null.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        communication_preference_edit = cls(
            end=end,
            solicit_code=solicit_code,
            start=start,
        )

        communication_preference_edit.additional_properties = d
        return communication_preference_edit
