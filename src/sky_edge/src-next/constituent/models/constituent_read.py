...
from ..models.constituent_read_fundraiser_status import ConstituentReadFundraiserStatus
from ..models.constituent_read_receipt_type import ConstituentReadReceiptType
from ..models.constituent_read_type import ConstituentReadType
...
T = TypeVar("T", bound="ConstituentRead")


@_attrs_define
class ConstituentRead:
    ...
    more.
        ...
        Attributes:
            ...
            fundraiser_status (ConstituentReadFundraiserStatus | Unset): Indicates whether the constituent is a fundraiser.
            ...
            title_2 (str | Unset): The constituent's secondary title. Available values are the entries in the <a href="https
                ...
                table. For individuals only.
            type_ (ConstituentReadType | Unset): The type of constituent. Available values are <i>Individual</i> and
                <i>Organization</i>.
            ...
            receipt_type (ConstituentReadReceiptType | Unset): The receipt type of the constituent.
            ...
            import_id (str | Unset): The import id for the constituent.
            is_constituent (bool | Unset): Flag indicating whether or not this individual or organization is a constituent
    ...
    fundraiser_status: ConstituentReadFundraiserStatus | Unset = UNSET
    ...
    type_: ConstituentReadType | Unset = UNSET
    ...
    receipt_type: ConstituentReadReceiptType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fundraiser_status: ConstituentReadFundraiserStatus | Unset
        if isinstance(_fundraiser_status, Unset):
            fundraiser_status = UNSET
        else:
            fundraiser_status = ConstituentReadFundraiserStatus(_fundraiser_status)
        ...
        type_: ConstituentReadType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = ConstituentReadType(_type_)
        ...
        receipt_type: ConstituentReadReceiptType | Unset
        if isinstance(_receipt_type, Unset):
            receipt_type = UNSET
        else:
            receipt_type = ConstituentReadReceiptType(_receipt_type)
        ...
        constituent_read.additional_properties = d
        return constituent_read
