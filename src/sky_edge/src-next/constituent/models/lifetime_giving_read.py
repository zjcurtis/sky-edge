...
class LifetimeGivingRead:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.total_committed_matching_gifts, Unset):
            total_committed_matching_gifts = self.total_committed_matching_gifts.to_dict()
        ...
        if total_committed_matching_gifts is not UNSET:
            field_dict["total_committed_matching_gifts"] = total_committed_matching_gifts
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_total_committed_matching_gifts, Unset):
            ...
            total_committed_matching_gifts = Currency.from_dict(_total_committed_matching_gifts)
        ...
        if isinstance(_total_received_matching_gifts, Unset):
            ...
            total_received_matching_gifts = Currency.from_dict(_total_received_matching_gifts)
