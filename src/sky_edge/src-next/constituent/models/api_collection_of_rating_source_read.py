...
if TYPE_CHECKING:
    from ..models.rating_source_read import RatingSourceRead


T = TypeVar("T", bound="ApiCollectionOfRatingSourceRead")


@_attrs_define
class ApiCollectionOfRatingSourceRead:
    ...
    large data sets. This entity includes helpful metadata and properties to paginate and iterate through the data.
        ...
        Attributes:
            ...
            value (list[RatingSourceRead] | Unset): The set of items included in the response. This may be a subset of the
                items in the collection.
    """

    count: int | Unset = UNSET
    next_link: str | Unset = UNSET
    value: list[RatingSourceRead] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = RatingSourceRead.from_dict(value_item_data)

                value.append(value_item)

        api_collection_of_rating_source_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_of_rating_source_read.additional_properties = d
        return api_collection_of_rating_source_read
