...
from ...models.communication_preference_add import CommunicationPreferenceAdd
...
def _get_kwargs(
    *,
    body: CommunicationPreferenceAdd | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    r"""Communication preference (Create)

     Creates a constituent communication preference. This endpoint will be deprecated in a future version
    ...
    preference/operations/CreateConstituentSolicitCode\">Constituent solicit code (Post)</a>, in the
    Communication Preference API instead.

    Args:
        body (CommunicationPreferenceAdd | Unset): Communication preferences provide guidance on
