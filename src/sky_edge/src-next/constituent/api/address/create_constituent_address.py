...
from ...models.address_add import AddressAdd
...
def sync_detailed(
    *,
    ...
    Args:
        body (AddressAdd | Unset): Addresses store information about constituent residences and
