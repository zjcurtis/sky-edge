...
from ...models.api_collection_of_name_format_configuration_read import ApiCollectionOfNameFormatConfigurationRead
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApiCollectionOfNameFormatConfigurationRead.from_dict(response.json())
