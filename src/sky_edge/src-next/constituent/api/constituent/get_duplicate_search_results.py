...
from ...models.api_collection_of_duplicate_search_result_read import ApiCollectionOfDuplicateSearchResultRead
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApiCollectionOfDuplicateSearchResultRead.from_dict(response.json())
