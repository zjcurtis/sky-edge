...
def sync_detailed(
    *,
    ...
    """Constituent custom field list (All constituents)
     ...
     Returns a paginated list of constituent custom fields.
    <p />
    The default sorting behavior is to list constituent custom fields in ascending order based on when
    they were created.
    <p />
    However, the <code>last_modified</code> parameter overrides the default sorting behavior to list
    constituent custom fields in ascending order based on when they were last modified. The
    <code>last_modified</code> parameter also adds the <code>sort_token</code> parameter to the
    <code>next_link</code> URL to ensure that constituent custom fields are stably sorted and that order
    ...
    sorting behavior is to list constituent custom fields based on when they were last modified.
