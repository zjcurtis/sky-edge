...
class CustomFieldCategoryDetailsCollection:
    """A collection of custom field category details.

    Attributes:
        count (int | Unset): The total number of items in the collection before limit/offset.
        value (list[CustomFieldCategoryDetails] | None | Unset): The set of items included in the response. This may be
            a subset of the items in the collection.
    """

    count: int | Unset = UNSET
    value: list[CustomFieldCategoryDetails] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> list[CustomFieldCategoryDetails] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = CustomFieldCategoryDetails.from_dict(value_type_0_item_data)
