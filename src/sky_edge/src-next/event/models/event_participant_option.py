...
from ..models.event_participant_option_input_type import EventParticipantOptionInputType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.event_participant_option_list_option import EventParticipantOptionListOption
...
class EventParticipantOption:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_list_options(data: object) -> list[EventParticipantOptionListOption] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for list_options_type_0_item_data in _list_options_type_0:
                    list_options_type_0_item = EventParticipantOptionListOption.from_dict(list_options_type_0_item_data)
