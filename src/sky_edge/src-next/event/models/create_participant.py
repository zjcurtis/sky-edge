...
from ..models.create_participant_invitation_status import CreateParticipantInvitationStatus
from ..models.create_participant_rsvp_status import CreateParticipantRsvpStatus
...
T = TypeVar("T", bound="CreateParticipant")
...
class CreateParticipant:
    ...
    They can include constituents who receive invitations or register for the event.
        ...
        Attributes:
            ...
            rsvp_status (CreateParticipantRsvpStatus | Unset): The status of the participant's engagement with the
            ...
            invitation_status (CreateParticipantInvitationStatus | Unset): The status of the invitation to the
    ...
    rsvp_status: CreateParticipantRsvpStatus | Unset = UNSET
    attended: bool | Unset = UNSET
    invitation_status: CreateParticipantInvitationStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rsvp_status: CreateParticipantRsvpStatus | Unset
        if isinstance(_rsvp_status, Unset):
            rsvp_status = UNSET
        else:
            rsvp_status = CreateParticipantRsvpStatus(_rsvp_status)

        attended = d.pop("attended", UNSET)

        _invitation_status = d.pop("invitation_status", UNSET)
        invitation_status: CreateParticipantInvitationStatus | Unset
        if isinstance(_invitation_status, Unset):
            invitation_status = UNSET
        else:
            invitation_status = CreateParticipantInvitationStatus(_invitation_status)
