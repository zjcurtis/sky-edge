...
T = TypeVar("T", bound="EditEventLocation")


@_attrs_define
class EditEventLocation:
    """Defines the data model used for edit location.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        administrative_area = _parse_administrative_area(d.pop("administrative_area", UNSET))
        ...
        dependent_locality = _parse_dependent_locality(d.pop("dependent_locality", UNSET))
