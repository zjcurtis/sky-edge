...
from ..models.participant_entry_participant_option_input_type import ParticipantEntryParticipantOptionInputType
        ...
        def _parse_values(data: object) -> list[ParticipantOptionValue] | None | Unset:
            ...
            try:
                ...
                for values_type_0_item_data in _values_type_0:
                    values_type_0_item = ParticipantOptionValue.from_dict(values_type_0_item_data)
