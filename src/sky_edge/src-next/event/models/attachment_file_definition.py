...
if TYPE_CHECKING:
    from ..models.attachment_file_request_metadata import AttachmentFileRequestMetadata
...
class AttachmentFileDefinition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_file_upload_request, Unset):
            ...
            file_upload_request = AttachmentFileRequestMetadata.from_dict(_file_upload_request)
        ...
        if isinstance(_thumbnail_upload_request, Unset):
            ...
            thumbnail_upload_request = AttachmentFileRequestMetadata.from_dict(_thumbnail_upload_request)
