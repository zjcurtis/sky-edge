...
from ..models.constituent_event_participation_invitation_status import ConstituentEventParticipationInvitationStatus
from ..models.constituent_event_participation_rsvp_status import ConstituentEventParticipationRsvpStatus
...
class ConstituentEventParticipation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_invitation_status, Unset):
            ...
            invitation_status = ConstituentEventParticipationInvitationStatus(_invitation_status)
