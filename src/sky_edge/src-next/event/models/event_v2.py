...
if TYPE_CHECKING:
    ...
    from ..models.location_v2 import LocationV2


T = TypeVar("T", bound="EventV2")
...
class EventV2:
    ...
    encourage donations.
        ...
        Attributes:
            id (None | str | Unset): The ID of the event.
            ...
            location (LocationV2 | Unset): Defines the data model used for a location.
            date_added (datetime.datetime | Unset): The date when the event was created. Uses<a
                href="https://tools.ietf.org/html/rfc3339"> ISO-8601 format</a>: <i>1969-11-21T10:29:43-04:00</i>.
            date_modified (datetime.datetime | Unset): The date when the event was last modified. Uses<a
                href="https://tools.ietf.org/html/rfc3339"> ISO-8601 format</a>: <i>1969-11-21T10:29:43-04:00</i>.
    ...
    location: LocationV2 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location: LocationV2 | Unset
        if isinstance(_location, Unset):
            location = UNSET
        else:
            location = LocationV2.from_dict(_location)
