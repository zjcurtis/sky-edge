...
T = TypeVar("T", bound="CustomFieldCollection")
...
class CustomFieldCollection:
    ...
    Attributes:
        ...
        value (list[CustomField] | None | Unset): The set of items included in the response. This may be a subset of the
            items in the collection.
    """

    count: int | Unset = UNSET
    value: list[CustomField] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> list[CustomField] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = CustomField.from_dict(value_type_0_item_data)
