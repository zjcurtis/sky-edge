...
@_attrs_define
class ServiceError:
    """Explains the reason for an error.

    Attributes:
        message (None | str | Unset): The description of the error.
        error_name (None | str | Unset): The name of the error.
        error_code (int | Unset): The number associated with the error.
        raw_message (None | str | Unset): The description of the error which can include argument placeholders.
        error_args (list[str] | None | Unset): The argument data for the placeholders.
    """
