...
T = TypeVar("T", bound="ParticipationLevel")
...
class ParticipationLevel:
    ...
    Attributes:
        id (None | str | Unset): The ID of the participation level.
        name (None | str | Unset): The name of the participation level.
        is_inactive (bool | Unset): Whether the participation level is inactive. True if inactive.
    """
