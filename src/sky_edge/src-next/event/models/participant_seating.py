...
T = TypeVar("T", bound="ParticipantSeating")


@_attrs_define
class ParticipantSeating:
    """Represents the seating information for the participant.
