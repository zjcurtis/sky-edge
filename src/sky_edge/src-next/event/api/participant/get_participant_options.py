...
from ...models.participant_option_collection import ParticipantOptionCollection
...
) -> ParticipantOptionCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = ParticipantOptionCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ParticipantOptionCollection | list[ServiceError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ParticipantOptionCollection | list[ServiceError]
    """
