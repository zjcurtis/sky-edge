...
from ...models.participant_fee_payment_collection import ParticipantFeePaymentCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/participants/{participant_id}/feepayments".format(
...
) -> ParticipantFeePaymentCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = ParticipantFeePaymentCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ParticipantFeePaymentCollection | list[ServiceError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ParticipantFeePaymentCollection | list[ServiceError]
    """
