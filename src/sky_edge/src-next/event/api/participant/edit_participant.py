...
from ...models.edit_participant import EditParticipant
...
def _get_kwargs(
    participant_id: str,
    *,
    body: EditParticipant | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/participants/{participant_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Edit a participant
     ...
     Edits the details about a participant.

    Args:
        participant_id (str):
        body (EditParticipant | Unset): Participants are individuals or organizations who engage
