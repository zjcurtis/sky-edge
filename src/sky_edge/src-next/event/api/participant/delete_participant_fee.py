...
def _get_kwargs(
    participant_fee_id: str,
) -> dict[str, Any]:

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/participantfees/{participant_fee_id}".format(
            participant_fee_id=quote(str(participant_fee_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Delete a participant fee

     Deletes a participant fee for a participant.
    ...
    kwargs = _get_kwargs(
        participant_fee_id=participant_fee_id,
    )
