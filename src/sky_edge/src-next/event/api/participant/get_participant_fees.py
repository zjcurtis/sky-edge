...
from ...models.participant_fee_collection import ParticipantFeeCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/participants/{participant_id}/fees".format(
...
) -> ParticipantFeeCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = ParticipantFeeCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ParticipantFeeCollection | list[ServiceError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ParticipantFeeCollection | list[ServiceError]
    """
