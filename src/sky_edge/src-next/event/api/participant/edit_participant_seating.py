...
from ...models.edit_participant_seating import EditParticipantSeating
...
def _get_kwargs(
    participant_id: str,
    *,
    body: EditParticipantSeating | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Edit participant seating (PREVIEW)

     Edits the seating details for a participant.

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        participant_id (str):
        body (EditParticipantSeating | Unset): A participant's seat is their seating assignment
            for an event.
