...
def _get_kwargs(
    event_id: str,
    *,
    attachment_tag: str | Unset = UNSET,
) -> dict[str, Any]:
...
) -> AttachmentCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = AttachmentCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AttachmentCollection | list[ServiceError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get event attachments
     ...
     Returns a list of attachments for an event.

    Args:
        event_id (str):
        attachment_tag (str | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        AttachmentCollection | list[ServiceError]
    """
