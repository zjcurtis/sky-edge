...
from ...models.event_participant_option_collection import EventParticipantOptionCollection
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/events/{event_id}/eventparticipantoptions".format(
...
) -> EventParticipantOptionCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = EventParticipantOptionCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EventParticipantOptionCollection | list[ServiceError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EventParticipantOptionCollection | list[ServiceError]
    """
