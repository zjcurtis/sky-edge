...
from ...models.create_participation_level import CreateParticipationLevel
...
def _get_kwargs(
    *,
    body: CreateParticipationLevel | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Create a participation level

     Creates a new participation level.

    Args:
        body (CreateParticipationLevel | Unset): Participation levels are the level of involvement
