...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Event | list[ServiceError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Get an event
     ...
     Returns information about an event. <bb-alert bb-alert-type=\"warning\" bb-alert-
    closeable=\"false\"><b>This endpoint is deprecated. For more detailed event information, use the <a
    href=\"https://developer.sky.blackbaud.com/api#api=event&operation=GetEventV2\">Get an eventV2</a>
