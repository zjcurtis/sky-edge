...
from ...models.event_group_collection import EventGroupCollection
...
) -> EventGroupCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = EventGroupCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EventGroupCollection | list[ServiceError]]:
    return Response(
...
def sync(
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Returns:
        EventGroupCollection | list[ServiceError]
    """
