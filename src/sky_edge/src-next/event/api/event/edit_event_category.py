...
from ...models.edit_event_category import EditEventCategory
...
def _get_kwargs(
    ...
    *,
    body: EditEventCategory | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Edit an event category
     ...
     Edits the details about an event category.

    Args:
        event_category_id (str):
        body (EditEventCategory | Unset): Event categories help group different types of events.
