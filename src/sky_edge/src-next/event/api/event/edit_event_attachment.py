...
from ...models.edit_attachment import EditAttachment
...
def _get_kwargs(
    ...
    attachment_id: str,
    *,
    body: EditAttachment | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Edit an event attachment

     Edits an event attachment.

    Args:
        event_id (str):
        attachment_id (str):
        body (EditAttachment | Unset): A link or a physical attachment for an event. Physical
            attachments are uploaded files such as images, PDFs, or Word documents that are saved
            locally or on the network. They are stored and managed in the system. Link attachments are
            links to files such as images, blog posts, or YouTube videos that are online or in a cloud
            storage account. They are stored and managed externally.
