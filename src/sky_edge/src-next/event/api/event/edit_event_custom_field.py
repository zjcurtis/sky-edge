...
from ...models.edit_custom_field_request import EditCustomFieldRequest
...
def _get_kwargs(
    custom_field_id: str,
    *,
    body: EditCustomFieldRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/events/customfields/{custom_field_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Edit event custom field (PREVIEW)

     Edit event custom field.

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        custom_field_id (str):
        body (EditCustomFieldRequest | Unset): Represents the custom field for the event.
