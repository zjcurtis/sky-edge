...
from ...models.edit_participation_level import EditParticipationLevel
from ...models.service_error import ServiceError
from ...types import UNSET, Response, Unset


def _get_kwargs(
    participation_level_id: str,
    *,
    body: EditParticipationLevel | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/participationlevels/{participation_level_id}".format(
            participation_level_id=quote(str(participation_level_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Edit a participation level

     Edits the details about a participation level.

    Args:
        participation_level_id (str):
        body (EditParticipationLevel | Unset): Participation levels are the level of involvement
            participants have in an event.
    ...
    kwargs = _get_kwargs(
        participation_level_id=participation_level_id,
        body=body,
    )
