...
from ...models.event_fee_collection import EventFeeCollection
...
) -> EventFeeCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = EventFeeCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EventFeeCollection | list[ServiceError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EventFeeCollection | list[ServiceError]
    """
