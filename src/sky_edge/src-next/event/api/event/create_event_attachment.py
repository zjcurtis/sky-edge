...
def _get_kwargs(
    event_id: str,
    *,
    body: CreateAttachment | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/events/{event_id}/attachments".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Create an event attachment
     ...
     Creates an event attachment.

    Args:
        event_id (str):
        body (CreateAttachment | Unset): A link or a physical attachment for an event. Physical
