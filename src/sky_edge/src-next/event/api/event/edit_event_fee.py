...
from ...models.edit_event_fee import EditEventFee
...
def _get_kwargs(
    fee_id: str,
    *,
    body: EditEventFee | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/eventfees/{fee_id}".format(
            fee_id=quote(str(fee_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        fee_id (str):
        body (EditEventFee | Unset): Event fees are how much an organization charges for
            individuals or organizations to participate in or attend the event. An organization might
            also charge for other add-on items such as t-shirts or valet parking.
