...
from ...models.country_create import CountryCreate
from ...models.post_response import PostResponse


def _get_kwargs(
    *,
    body: CountryCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (CountryCreate | Unset): RE7 Country record create class from the dbo.COUNTRY_CODES
