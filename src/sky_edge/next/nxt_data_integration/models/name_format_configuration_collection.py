...
if TYPE_CHECKING:
    from ..models.name_format_configuration_for_list import (
...
class NameFormatConfigurationCollection:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(
            data: object,
        ) -> list[NameFormatConfigurationForList] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = NameFormatConfigurationForList.from_dict(
