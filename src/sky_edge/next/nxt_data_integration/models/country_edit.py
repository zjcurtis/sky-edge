...
from ..models.country_edit_country_code import CountryEditCountryCode
from ..models.country_edit_country_currency_placement import (
    CountryEditCountryCurrencyPlacement,
)
from ..models.country_edit_re7_country_codes import CountryEditRE7CountryCodes

T = TypeVar("T", bound="CountryEdit")


@_attrs_define
class CountryEdit:
    """RE7 Country record edit class from the dbo.COUNTRY_CODES table in Raiser's Edge.
    ...
    Attributes:
        ...
        currency_placement_id (CountryEditCountryCurrencyPlacement | Unset): The value used to determine where the
        ...
        leading_zero (bool | Unset): Value used to indicate whether a leading zero should be placed when displaying
            currency.
        iso_code (CountryEditRE7CountryCodes | Unset): The country's ISO code.
        label_format_country (CountryEditCountryCode | Unset): Value used to indicate the label format for the country.
    ...
    currency_placement_id: CountryEditCountryCurrencyPlacement | Unset = UNSET
    leading_zero: bool | Unset = UNSET
    iso_code: CountryEditRE7CountryCodes | Unset = UNSET
    label_format_country: CountryEditCountryCode | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        thousand_separator = _parse_thousand_separator(
            d.pop("thousand_separator", UNSET)
        )

        decimal_digits = d.pop("decimal_digits", UNSET)

        _currency_placement_id = d.pop("currency_placement_id", UNSET)
        currency_placement_id: CountryEditCountryCurrencyPlacement | Unset
        if isinstance(_currency_placement_id, Unset):
            currency_placement_id = UNSET
        else:
            currency_placement_id = CountryEditCountryCurrencyPlacement(
                _currency_placement_id
            )

        leading_zero = d.pop("leading_zero", UNSET)

        _iso_code = d.pop("iso_code", UNSET)
        iso_code: CountryEditRE7CountryCodes | Unset
        if isinstance(_iso_code, Unset):
            iso_code = UNSET
        else:
            iso_code = CountryEditRE7CountryCodes(_iso_code)

        _label_format_country = d.pop("label_format_country", UNSET)
        label_format_country: CountryEditCountryCode | Unset
        if isinstance(_label_format_country, Unset):
            label_format_country = UNSET
        else:
            label_format_country = CountryEditCountryCode(_label_format_country)
