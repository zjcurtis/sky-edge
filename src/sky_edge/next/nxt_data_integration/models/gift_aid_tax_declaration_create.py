...
from ..models.gift_aid_tax_declaration_create_gift_aid_pays_tax import (
    GiftAidTaxDeclarationCreateGiftAidPaysTax,
)

T = TypeVar("T", bound="GiftAidTaxDeclarationCreate")


@_attrs_define
class GiftAidTaxDeclarationCreate:
    """A record from the dbo.ConstituentTaxDeclaration table in Raiser's Edge.

    Attributes:
        constituent_id (int): The immutable system record ID of the constituent.
        declaration_starts (datetime.datetime): Date the declaration starts.
        import_id (None | str | Unset): The import id.
        constituent_pays_tax (GiftAidTaxDeclarationCreateGiftAidPaysTax | Unset): Constituent pays tax status (Yes, No,
            Unknown).
    ...
    constituent_pays_tax: GiftAidTaxDeclarationCreateGiftAidPaysTax | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        constituent_pays_tax: GiftAidTaxDeclarationCreateGiftAidPaysTax | Unset
        if isinstance(_constituent_pays_tax, Unset):
            constituent_pays_tax = UNSET
        else:
            constituent_pays_tax = GiftAidTaxDeclarationCreateGiftAidPaysTax(
        ...
        gift_aid_tax_declaration_create = cls(
            constituent_id=constituent_id,
            declaration_starts=declaration_starts,
            import_id=import_id,
        ...
        return gift_aid_tax_declaration_create
