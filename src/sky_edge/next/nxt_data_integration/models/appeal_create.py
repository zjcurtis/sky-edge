...
T = TypeVar("T", bound="AppealCreate")


@_attrs_define
class AppealCreate:
    """A record from the dbo.APPEAL table in Raiser's Edge.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        appeal_category_id = _parse_appeal_category_id(
            d.pop("appeal_category_id", UNSET)
        )
