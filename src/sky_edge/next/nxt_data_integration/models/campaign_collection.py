...
T = TypeVar("T", bound="CampaignCollection")
...
class CampaignCollection:
    ...
    Attributes:
        count (int | Unset):
        value (list[Campaign] | None | Unset):
    """

    count: int | Unset = UNSET
    value: list[Campaign] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> list[Campaign] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = Campaign.from_dict(value_type_0_item_data)
                ...
                pass
            return cast(list[Campaign] | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        campaign_collection = cls(
            count=count,
            value=value,
        )
