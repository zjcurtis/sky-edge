...
from ..models.gift_aid_tax_declaration_gift_aid_pays_tax import (
    GiftAidTaxDeclarationGiftAidPaysTax,
)

T = TypeVar("T", bound="GiftAidTaxDeclaration")


@_attrs_define
class GiftAidTaxDeclaration:
    """
    Attributes:
        declaration_starts (datetime.datetime): Date the declaration starts.
        declaration_id (int | Unset):
        constituent_id (int | Unset):
        tax_payer_status_id (int | None | Unset):
        declaration_indicator_id (int | None | Unset):
        declaration_source_id (int | None | Unset):
        import_id (None | str | Unset): The import id.
        constituent_pays_tax (GiftAidTaxDeclarationGiftAidPaysTax | Unset): Constituent pays tax status (Yes, No,
            Unknown).
    ...
    declaration_id: int | Unset = UNSET
    constituent_id: int | Unset = UNSET
    tax_payer_status_id: int | None | Unset = UNSET
    declaration_indicator_id: int | None | Unset = UNSET
    declaration_source_id: int | None | Unset = UNSET
    import_id: None | str | Unset = UNSET
    constituent_pays_tax: GiftAidTaxDeclarationGiftAidPaysTax | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tax_payer_status_id: int | None | Unset
        if isinstance(self.tax_payer_status_id, Unset):
            tax_payer_status_id = UNSET
        else:
            tax_payer_status_id = self.tax_payer_status_id

        declaration_indicator_id: int | None | Unset
        if isinstance(self.declaration_indicator_id, Unset):
            declaration_indicator_id = UNSET
        else:
            declaration_indicator_id = self.declaration_indicator_id

        declaration_source_id: int | None | Unset
        if isinstance(self.declaration_source_id, Unset):
            declaration_source_id = UNSET
        else:
            declaration_source_id = self.declaration_source_id
        ...
        if tax_payer_status_id is not UNSET:
            field_dict["tax_payer_status_id"] = tax_payer_status_id
        if declaration_indicator_id is not UNSET:
            field_dict["declaration_indicator_id"] = declaration_indicator_id
        if declaration_source_id is not UNSET:
            field_dict["declaration_source_id"] = declaration_source_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        declaration_id = d.pop("declaration_id", UNSET)

        constituent_id = d.pop("constituent_id", UNSET)

        def _parse_tax_payer_status_id(data: object) -> int | None | Unset:
            if data is None:
                return data
        ...
        tax_payer_status_id = _parse_tax_payer_status_id(
            d.pop("tax_payer_status_id", UNSET)
        )

        def _parse_declaration_indicator_id(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        declaration_indicator_id = _parse_declaration_indicator_id(
            d.pop("declaration_indicator_id", UNSET)
        )

        def _parse_declaration_source_id(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        declaration_source_id = _parse_declaration_source_id(
            d.pop("declaration_source_id", UNSET)
        )
        ...
        constituent_pays_tax: GiftAidTaxDeclarationGiftAidPaysTax | Unset
        if isinstance(_constituent_pays_tax, Unset):
            constituent_pays_tax = UNSET
        else:
            constituent_pays_tax = GiftAidTaxDeclarationGiftAidPaysTax(
        ...
        def _parse_confirmation_returned(
            data: object,
        ...
        confirmation_returned = _parse_confirmation_returned(
            d.pop("confirmation_returned", UNSET)
        )
        ...
        declaration_indicator = _parse_declaration_indicator(
            d.pop("declaration_indicator", UNSET)
        )
        ...
        declaration_source = _parse_declaration_source(
            d.pop("declaration_source", UNSET)
        )
        ...
        gift_aid_tax_declaration = cls(
            declaration_starts=declaration_starts,
            declaration_id=declaration_id,
            constituent_id=constituent_id,
            tax_payer_status_id=tax_payer_status_id,
            declaration_indicator_id=declaration_indicator_id,
        ...
        return gift_aid_tax_declaration
