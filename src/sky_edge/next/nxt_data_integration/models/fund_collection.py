...
T = TypeVar("T", bound="FundCollection")


@_attrs_define
class FundCollection:
    """Defines a collection of fund list entries.

    Attributes:
        count (int | Unset):
        value (list[Fund] | None | Unset):
    """

    count: int | Unset = UNSET
    value: list[Fund] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> list[Fund] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for value_type_0_item_data in _value_type_0:
                    value_type_0_item = Fund.from_dict(value_type_0_item_data)
                ...
                pass
            return cast(list[Fund] | None | Unset, data)
