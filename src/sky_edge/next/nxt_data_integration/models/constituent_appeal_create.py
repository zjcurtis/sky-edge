...
T = TypeVar("T", bound="ConstituentAppealCreate")


@_attrs_define
class ConstituentAppealCreate:
    """Contains the fields for creating a record in the dbo.CONSTITUENT_APPEAL table in Raiser's Edge.

    Attributes:
        constituent_id (int): The immutable system record ID of the constituent associated with the constituent appeal.
        appeal_description (str): The appeal description; used to look up the appeal record ID.
        import_id (None | str | Unset): The import ID of the constituent appeal.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        package_description = _parse_package_description(
            d.pop("package_description", UNSET)
        )
        ...
        response_description = _parse_response_description(
            d.pop("response_description", UNSET)
        )
        ...
        market_finder_number = _parse_market_finder_number(
            d.pop("market_finder_number", UNSET)
        )
        ...
        marketing_source_code = _parse_marketing_source_code(
            d.pop("marketing_source_code", UNSET)
        )

        constituent_appeal_create = cls(
            constituent_id=constituent_id,
            appeal_description=appeal_description,
            import_id=import_id,
        ...
        return constituent_appeal_create
