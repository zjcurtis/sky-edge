...
class Relationship:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relation_description = _parse_relation_description(
            d.pop("relation_description", UNSET)
        )
        ...
        reciprocal_relationship_type = _parse_reciprocal_relationship_type(
            d.pop("reciprocal_relationship_type", UNSET)
        )
