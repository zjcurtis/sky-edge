...
T = TypeVar("T", bound="ConstituentSearchResult")
...
class ConstituentSearchResult:
    ...
    Attributes:
        matched_alias (None | str | Unset): The matched alias name.
        matched_email (None | str | Unset): The matched email.
        matched_phone (None | str | Unset): The matched phone number.
    ...
    matched_alias: None | str | Unset = UNSET
    matched_email: None | str | Unset = UNSET
    matched_phone: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        matched_alias: None | str | Unset
        if isinstance(self.matched_alias, Unset):
            matched_alias = UNSET
        else:
            matched_alias = self.matched_alias

        matched_email: None | str | Unset
        if isinstance(self.matched_email, Unset):
            matched_email = UNSET
        else:
            matched_email = self.matched_email

        matched_phone: None | str | Unset
        if isinstance(self.matched_phone, Unset):
            matched_phone = UNSET
        else:
        ...
        field_dict.update({})
        if matched_alias is not UNSET:
            field_dict["matched_alias"] = matched_alias
        if matched_email is not UNSET:
            field_dict["matched_email"] = matched_email
        if matched_phone is not UNSET:
            field_dict["matched_phone"] = matched_phone
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_matched_alias(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        matched_alias = _parse_matched_alias(d.pop("matched_alias", UNSET))

        def _parse_matched_email(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        matched_email = _parse_matched_email(d.pop("matched_email", UNSET))

        def _parse_matched_phone(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        matched_phone = _parse_matched_phone(d.pop("matched_phone", UNSET))
        ...
        address_city_state = _parse_address_city_state(
            d.pop("address_city_state", UNSET)
        )
        ...
        return constituent_search_result
