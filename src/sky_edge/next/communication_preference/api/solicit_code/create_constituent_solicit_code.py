...
from ...models.constituent_solicit_code_add import ConstituentSolicitCodeAdd
...
def _get_kwargs(
    *,
    body: ConstituentSolicitCodeAdd | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/constituentsolicitcodes",
    }
...
def sync_detailed(
    *,
    ...
    """Constituent solicit code (Create)

     Creates a constituent solicit code.

    Args:
        body (ConstituentSolicitCodeAdd | Unset): Solicit codes provide guidance on how to contact
            constituents. These rules describe instructions and restrictions about when to reach out
            to constituents and how to tailor communications to honor their requests.
