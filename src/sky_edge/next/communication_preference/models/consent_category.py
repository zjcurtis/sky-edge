...
T = TypeVar("T", bound="ConsentCategory")
...
class ConsentCategory:
    ...
    Attributes:
        description (None | str | Unset): The name of the consent category.
        inactive (bool | None | Unset): Indicates whether the consent category is inactive.
        sequence (int | None | Unset): The placement of the category in the order of category table values, if defined.
    """
