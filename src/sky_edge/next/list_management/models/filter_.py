...
class Filter:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.selected_filters, Unset):
            ...
            for selected_filters_type_0_item_data in self.selected_filters:
                selected_filters_type_0_item = (
                    selected_filters_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_filter_items(data: object) -> list[FilterItem] | None | Unset:
            ...
            try:
                ...
                for filter_items_type_0_item_data in _filter_items_type_0:
                    filter_items_type_0_item = FilterItem.from_dict(
                        filter_items_type_0_item_data
                    )
        ...
        def _parse_selected_filters(
            data: object,
        ) -> list[SelectedFilter] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for selected_filters_type_0_item_data in _selected_filters_type_0:
                    selected_filters_type_0_item = SelectedFilter.from_dict(
                        selected_filters_type_0_item_data
                    )
