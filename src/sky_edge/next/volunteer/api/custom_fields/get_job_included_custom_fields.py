...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/jobs/{job_id}/includedcustomfields".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List included volunteer custom fields (PREVIEW)

     Returns the custom fields that are required for inclusion in the specified job.
