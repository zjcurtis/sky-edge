...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/jobs/{job_id}/excludedcustomfields".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List excluded volunteer custom fields (PREVIEW)

     Returns the custom fields that exclude volunteers from the specified job.
