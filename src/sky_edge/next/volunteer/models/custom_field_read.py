...
from ..models.custom_field_data_type import CustomFieldDataType
...
class CustomFieldRead:
    ...
    this specialized information, use custom fields.
        ...
        Attributes:
            ...
            type_ (CustomFieldDataType | Unset): Represents the data type of a custom field
    ...
    type_: CustomFieldDataType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: CustomFieldDataType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = CustomFieldDataType(_type_)
