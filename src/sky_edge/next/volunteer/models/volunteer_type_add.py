...
T = TypeVar("T", bound="VolunteerTypeAdd")


@_attrs_define
class VolunteerTypeAdd:
    """Represents a request to add a volunteer type classification
