...
T = TypeVar("T", bound="GetConsentList400ResponseTypes")


@_attrs_define
class GetConsentList400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            channels</td><td>One or more channels are invalid.</td></tr><tr><td>urn:blackbaud:invalid-id</td><td>One or more
            constituent identifiers are invalid.</td></tr><tr><td>urn:blackbaud:invalid-date-range</td><td>Invalid date
            range specified.</td></tr><tr><td>urn:blackbaud:invalid-response</td><td>Invalid consent
            response.</td></tr><tr><td>urn:blackbaud:invalid-source</td><td>Invalid consent source.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_consent_list_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_consent_list_400_response_types.additional_properties = d
        return get_consent_list_400_response_types
