...
from ..models.consent_read_channel import ConsentReadChannel
from ..models.consent_read_response import ConsentReadResponse

T = TypeVar("T", bound="ConsentRead")
...
class ConsentRead:
    ...
    Attributes:
        ...
        channel (ConsentReadChannel | Unset): The channel that the consent response applies
        ...
        response (ConsentReadResponse | Unset): How the constituent responded to consent for the specified
    ...
    channel: ConsentReadChannel | Unset = UNSET
    inactive: bool | None | Unset = UNSET
    date: datetime.datetime | Unset = UNSET
    response: ConsentReadResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        channel: ConsentReadChannel | Unset
        if isinstance(_channel, Unset):
            channel = UNSET
        else:
            channel = ConsentReadChannel(_channel)
        ...
        response: ConsentReadResponse | Unset
        if isinstance(_response, Unset):
            response = UNSET
        else:
            response = ConsentReadResponse(_response)
