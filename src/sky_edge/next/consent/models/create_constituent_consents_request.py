...
from ..models.create_constituent_consents_request_channel import (
    CreateConstituentConsentsRequestChannel,
)

if TYPE_CHECKING:
    from ..models.create_constituent_consent_request import (
...
class CreateConstituentConsentsRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.constituent_requests, Unset):
            ...
            for constituent_requests_type_0_item_data in self.constituent_requests:
                constituent_requests_type_0_item = (
                    constituent_requests_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_constituent_requests(
            data: object,
        ) -> list[CreateConstituentConsentRequest] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                ) in _constituent_requests_type_0:
                    constituent_requests_type_0_item = (
                        CreateConstituentConsentRequest.from_dict(
                            constituent_requests_type_0_item_data
                        )
                    )
        ...
        constituent_requests = _parse_constituent_requests(
            d.pop("constituent_requests", UNSET)
        )
