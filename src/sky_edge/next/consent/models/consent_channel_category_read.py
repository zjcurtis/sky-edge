...
if TYPE_CHECKING:
    from ..models.consent_solicit_code_assignment_read import (
...
class ConsentChannelCategoryRead:
    ...
    solicit_code_assignments: list[ConsentSolicitCodeAssignmentRead] | None | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_solicit_code_assignments(
            data: object,
        ) -> list[ConsentSolicitCodeAssignmentRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for (
                    ...
                    solicit_code_assignments_type_0_item = (
                        ConsentSolicitCodeAssignmentRead.from_dict(
                            solicit_code_assignments_type_0_item_data
                        )
                    )
