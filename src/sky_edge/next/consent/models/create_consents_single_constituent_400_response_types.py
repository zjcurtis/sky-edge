...
T = TypeVar("T", bound="CreateConsentsSingleConstituent400ResponseTypes")


@_attrs_define
class CreateConsentsSingleConstituent400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            channel</td><td>One or more channels are invalid.</td></tr><tr><td>urn:blackbaud:invalid-number-of-
            requests</td><td>A single bulk request must include between 1 and 500
            requests.</td></tr><tr><td>urn:blackbaud:invalid-id</td><td>The constituent identifier is
            invalid.</td></tr><tr><td>urn:blackbaud:invalid-consent-response</td><td>One or more consent responses are
            invalid.</td></tr><tr><td>urn:blackbaud:inactive-category</td><td>One or more consent categories are
            inactive.</td></tr><tr><td>urn:blackbaud:invalid-category</td><td>One or more consent categories are
            invalid.</td></tr><tr><td>urn:blackbaud:inactive-source</td><td>One or more requests include an inactive
            source.</td></tr><tr><td>urn:blackbaud:invalid-source</td><td>One or more consent sources are
            invalid.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_consents_single_constituent_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        create_consents_single_constituent_400_response_types.additional_properties = d
        return create_consents_single_constituent_400_response_types
