...
from ..models.consent_list_options_category_filter_type import (
    ConsentListOptionsCategoryFilterType,
)
from ..models.consent_list_options_channels_type_0_item import (
...
class ConsentListOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_channels(
            data: object,
        ) -> list[ConsentListOptionsChannelsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for channels_type_0_item_data in _channels_type_0:
                    channels_type_0_item = ConsentListOptionsChannelsType0Item(
                        channels_type_0_item_data
                    )
        ...
        if isinstance(_category_filter_type, Unset):
            ...
            category_filter_type = ConsentListOptionsCategoryFilterType(
                _category_filter_type
            )
