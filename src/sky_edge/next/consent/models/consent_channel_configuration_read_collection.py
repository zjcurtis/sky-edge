...
if TYPE_CHECKING:
    from ..models.consent_channel_configuration_read import (
...
class ConsentChannelConfigurationReadCollection:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.channel_configurations, Unset):
            ...
            for channel_configurations_type_0_item_data in self.channel_configurations:
                channel_configurations_type_0_item = (
                    channel_configurations_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_channel_configurations(
            data: object,
        ) -> list[ConsentChannelConfigurationRead] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                ) in _channel_configurations_type_0:
                    channel_configurations_type_0_item = (
                        ConsentChannelConfigurationRead.from_dict(
                            channel_configurations_type_0_item_data
                        )
                    )

                    channel_configurations_type_0.append(
                        channel_configurations_type_0_item
                    )
        ...
        channel_configurations = _parse_channel_configurations(
            d.pop("channel_configurations", UNSET)
        )
