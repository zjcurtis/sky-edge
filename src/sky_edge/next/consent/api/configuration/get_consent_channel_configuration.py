...
from ...models.consent_channel_configuration_read_collection import (
    ConsentChannelConfigurationReadCollection,
)
from ...models.get_consent_channel_configuration_channels_item import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ConsentChannelConfigurationReadCollection.from_dict(
            response.json()
        )
