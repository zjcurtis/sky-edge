...
T = TypeVar("T", bound="BadRequestResponseProblemDetails")


@_attrs_define
class BadRequestResponseProblemDetails:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:bad-
            request</td><td>Request was not in an acceptable format.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bad_request_response_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        bad_request_response_problem_details.additional_properties = d
        return bad_request_response_problem_details
