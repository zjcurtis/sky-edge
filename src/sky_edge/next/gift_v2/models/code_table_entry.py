...
class CodeTableEntry:
    """A predefined entry in a code table.

    Attributes:
        legacy_id (None | str | Unset): The legacy ID of the code table entry. Example: 1234.
        value (None | str | Unset): The value of the code table entry. Example: Test value.
    """
