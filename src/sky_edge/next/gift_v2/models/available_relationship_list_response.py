...
class AvailableRelationshipListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.available_relationship_response import (
        ...
        for available_relationships_item_data in _available_relationships:
            available_relationships_item = AvailableRelationshipResponse.from_dict(
                available_relationships_item_data
            )
