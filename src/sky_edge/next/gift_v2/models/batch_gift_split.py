...
from ..models.batch_gift_split_gift_aid_qualification_method import (
...
class BatchGiftSplit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_gift_aid_qualification_method, Unset):
            ...
            gift_aid_qualification_method = BatchGiftSplitGiftAidQualificationMethod(
                _gift_aid_qualification_method
            )
