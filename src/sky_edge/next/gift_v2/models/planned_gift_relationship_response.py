...
T = TypeVar("T", bound="PlannedGiftRelationshipResponse")


@_attrs_define
class PlannedGiftRelationshipResponse:
    """Represents a single planned gift relationship in the API response.

    Attributes:
        id (None | str): The unique identifier of the relationship record.
        ...
        spouse (bool | None | Unset): Whether the constituent relationship is a spouse relationship.
        head_of_household (bool | None | Unset): Whether the related constituent is the head of household.
    ...
    spouse: bool | None | Unset = UNSET
    head_of_household: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        spouse: bool | None | Unset
        if isinstance(self.spouse, Unset):
            spouse = UNSET
        else:
            spouse = self.spouse

        head_of_household: bool | None | Unset
        if isinstance(self.head_of_household, Unset):
            head_of_household = UNSET
        else:
        ...
        if head_of_household is not UNSET:
            field_dict["head_of_household"] = head_of_household
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        constituent_relationship_id = _parse_constituent_relationship_id(
            d.pop("constituent_relationship_id", UNSET)
        )
        ...
        constituent_bank_id = _parse_constituent_bank_id(
            d.pop("constituent_bank_id", UNSET)
        )
        ...
        constituent_education_id = _parse_constituent_education_id(
            d.pop("constituent_education_id", UNSET)
        )
        ...
        if isinstance(_reciprocal_relation_code, Unset):
            ...
            reciprocal_relation_code = CodeTableEntry.from_dict(
                _reciprocal_relation_code
            )
        ...
        def _parse_spouse(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_head_of_household(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        head_of_household = _parse_head_of_household(d.pop("head_of_household", UNSET))
        ...
        planned_gift_relationship_response = cls(
            id=id,
            gift_id=gift_id,
            relationship_type=relationship_type,
        ...
        return planned_gift_relationship_response
