...
class BatchGiftErrorRecord:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        exception_error_name = _parse_exception_error_name(
            d.pop("exception_error_name", UNSET)
        )
        ...
        exception_error_code = _parse_exception_error_code(
            d.pop("exception_error_code", UNSET)
        )
        ...
        exception_error_message = _parse_exception_error_message(
            d.pop("exception_error_message", UNSET)
        )
