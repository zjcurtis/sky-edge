...
class BatchGiftRead:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.batch_gift_errors, Unset):
            ...
            for batch_gift_errors_type_0_item_data in self.batch_gift_errors:
                batch_gift_errors_type_0_item = (
                    batch_gift_errors_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extensions(
            data: object,
        ) -> list[BatchGiftExtensionListItem] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for extensions_type_0_item_data in _extensions_type_0:
                    extensions_type_0_item = BatchGiftExtensionListItem.from_dict(
                        extensions_type_0_item_data
                    )
        ...
        def _parse_custom_fields(
            data: object,
        ) -> list[BatchGiftCustomFieldRead] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for custom_fields_type_0_item_data in _custom_fields_type_0:
                    custom_fields_type_0_item = BatchGiftCustomFieldRead.from_dict(
        ...
        def _parse_batch_gift_errors(
            data: object,
        ) -> list[BatchGiftErrorRecord] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for batch_gift_errors_type_0_item_data in _batch_gift_errors_type_0:
                    batch_gift_errors_type_0_item = BatchGiftErrorRecord.from_dict(
                        batch_gift_errors_type_0_item_data
                    )
        ...
        def _parse_tributes(data: object) -> list[BatchGiftTribute] | None | Unset:
            ...
            try:
                ...
                for tributes_type_0_item_data in _tributes_type_0:
                    tributes_type_0_item = BatchGiftTribute.from_dict(
