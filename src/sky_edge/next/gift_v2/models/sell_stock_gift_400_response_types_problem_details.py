...
T = TypeVar("T", bound="SellStockGift400ResponseTypesProblemDetails")


@_attrs_define
class SellStockGift400ResponseTypesProblemDetails:
    """The problem details when a 400 status code is returned for the SellStockGift endpoint
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:required-
            argument-not-assigned-value</td><td>The required argument '{0}' was not assigned a
            value.</td></tr><tr><td>urn:blackbaud:invalid-gift-type</td><td>A request was made with a gift type that is not
            valid for the operation: {0}</td></tr><tr><td>urn:blackbaud:sold-stock-details-argument-not-valid</td><td>There
            were issues with the contract: {0}</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sell_stock_gift_400_response_types_problem_details = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        sell_stock_gift_400_response_types_problem_details.additional_properties = d
        return sell_stock_gift_400_response_types_problem_details
