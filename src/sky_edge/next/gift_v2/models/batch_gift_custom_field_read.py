...
from ..models.batch_gift_custom_field_read_custom_field_data_type import (
...
class BatchGiftCustomFieldRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        table_entry_id_value = _parse_table_entry_id_value(
            d.pop("table_entry_id_value", UNSET)
        )
        ...
        constituent_id_value = _parse_constituent_id_value(
            d.pop("constituent_id_value", UNSET)
        )
        ...
        constituent_name_value = _parse_constituent_name_value(
            d.pop("constituent_name_value", UNSET)
        )
