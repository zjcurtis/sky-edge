...
from ..models.amend_gift_result_recurring_gift_amendment_status import (
...
class AmendGiftResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_related_gifts(
            data: object,
        ) -> list[AmendRelatedGiftResult] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for related_gifts_type_0_item_data in _related_gifts_type_0:
                    related_gifts_type_0_item = AmendRelatedGiftResult.from_dict(
                        related_gifts_type_0_item_data
                    )
