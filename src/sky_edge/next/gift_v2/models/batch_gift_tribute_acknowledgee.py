...
class BatchGiftTributeAcknowledgee:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_gift_tribute_id = _parse_batch_gift_tribute_id(
            d.pop("batch_gift_tribute_id", UNSET)
        )
        ...
        relationship_code_value = _parse_relationship_code_value(
            d.pop("relationship_code_value", UNSET)
        )
