...
class EditPaymentInformation:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.update_all_gifts_with_matching_account_token, Unset):
            ...
            update_all_gifts_with_matching_account_token = (
                self.update_all_gifts_with_matching_account_token
            )
        ...
        if update_all_gifts_with_matching_account_token is not UNSET:
            field_dict["update_all_gifts_with_matching_account_token"] = (
                update_all_gifts_with_matching_account_token
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_update_all_gifts_with_matching_account_token(
            data: object,
        ) -> bool | None | Unset:
            if data is None:
                return data
        ...
        update_all_gifts_with_matching_account_token = (
            _parse_update_all_gifts_with_matching_account_token(
