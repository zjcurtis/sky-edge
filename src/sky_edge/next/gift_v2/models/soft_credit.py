...
from ..models.soft_credit_recognition_credit_type import SoftCreditRecognitionCreditType
...
class SoftCredit:
    ...
    Attributes:
        ...
        credit_type (SoftCreditRecognitionCreditType | Unset): The type of recognition credit. Currently supports
    ...
    credit_type: SoftCreditRecognitionCreditType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credit_type: SoftCreditRecognitionCreditType | Unset
        if isinstance(_credit_type, Unset):
            credit_type = UNSET
        else:
            credit_type = SoftCreditRecognitionCreditType(_credit_type)
