...
from ...models.membership_upgrade import MembershipUpgrade
...
def _get_kwargs(
    ...
    *,
    body: MembershipUpgrade | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/memberships/{member_junction_id}/upgrade".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Upgrade a membership during cycle (PREVIEW)

     Upgrades a membership during cycle. Only Active or Lapsed memberships can be upgraded.

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        member_junction_id (str):
        body (MembershipUpgrade | Unset): Membership upgrade request model for during-cycle
            upgrades
