...
from ...models.linked_gift_edit import LinkedGiftEdit
...
def _get_kwargs(
    ...
    gift_id: str,
    *,
    body: LinkedGiftEdit | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/memberships/{member_junction_id}/linkedgifts/{gift_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Edit a linked gift for membership (PREVIEW)

     Edit the applied amount for a linked gift on a membership.
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Args:
        member_junction_id (str):
        gift_id (str):
        body (LinkedGiftEdit | Unset): Edit a single linked gift on a membership.
