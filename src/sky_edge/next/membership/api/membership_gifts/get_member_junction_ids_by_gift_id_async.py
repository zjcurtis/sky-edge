...
from ...models.get_member_junction_ids_by_gift_id_async_sort_direction import (
...
def _get_kwargs(
    gift_id: str,
    *,
    sort_direction: GetMemberJunctionIdsByGiftIdAsyncSortDirection
    | Unset = GetMemberJunctionIdsByGiftIdAsyncSortDirection.ASCENDING,
    limit: int | Unset = 500,
    offset: int | Unset = 0,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/memberships/gifts/{gift_id}/membershipjunctionids".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get membership junction IDs for a gift. (PREVIEW)

     Return membership junction IDs by gift ID

    ***This endpoint is in PREVIEW and may be changed or removed at any time.***

    Args:
        gift_id (str):
        sort_direction (GetMemberJunctionIdsByGiftIdAsyncSortDirection | Unset):  Default:
            GetMemberJunctionIdsByGiftIdAsyncSortDirection.ASCENDING.
        limit (int | Unset):  Default: 500.
        offset (int | Unset):  Default: 0.
        constituent_id (str | Unset):
