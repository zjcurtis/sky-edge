...
class MembershipSubCategory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        membership_subcategories_id = _parse_membership_subcategories_id(
            d.pop("membership_subcategories_id", UNSET)
        )
        ...
        membership_catgory_id = _parse_membership_catgory_id(
            d.pop("membership_catgory_id", UNSET)
        )
        ...
        membership_sub_category_name = _parse_membership_sub_category_name(
            d.pop("membership_sub_category_name", UNSET)
        )
