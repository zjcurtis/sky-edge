...
from ..models.membership_create_v2_membership_benefits_send_to import (
    MembershipCreateV2MembershipBenefitsSendTo,
)
from ..models.membership_create_v2_renewal_notice_type import (
...
class MembershipCreateV2:
    ...
    send_notice_to: MembershipCreateV2RenewalNoticeType | Unset = (
        MembershipCreateV2RenewalNoticeType.DONOR
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.membership_benefits, Unset):
            ...
            for membership_benefits_type_0_item_data in self.membership_benefits:
                membership_benefits_type_0_item = (
                    membership_benefits_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_send_benefits_to, Unset):
            ...
            send_benefits_to = MembershipCreateV2MembershipBenefitsSendTo(
                _send_benefits_to
            )
        ...
        def _parse_membership_cards(
            data: object,
        ) -> list[MembershipAddFormCardCreate] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for membership_cards_type_0_item_data in _membership_cards_type_0:
                    membership_cards_type_0_item = (
                        MembershipAddFormCardCreate.from_dict(
        ...
        def _parse_membership_benefits(
            data: object,
        ) -> list[MembershipBenefitCreate] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        membership_benefits = _parse_membership_benefits(
            d.pop("membership_benefits", UNSET)
        )
        ...
        membership_fundraisers = _parse_membership_fundraisers(
            d.pop("membership_fundraisers", UNSET)
        )
