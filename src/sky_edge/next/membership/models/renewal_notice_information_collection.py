...
class RenewalNoticeInformationCollection:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_renewal_notices(
            data: object,
        ) -> list[RenewalNoticeInformation] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for renewal_notices_type_0_item_data in _renewal_notices_type_0:
                    renewal_notices_type_0_item = RenewalNoticeInformation.from_dict(
                        renewal_notices_type_0_item_data
                    )
