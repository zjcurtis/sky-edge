...
T = TypeVar("T", bound="MembershipDowngrade")


@_attrs_define
class MembershipDowngrade:
    """Membership downgrade request model for during-cycle downgrades

    Attributes:
        category (Category): Category drop down data
        downgrade_date (datetime.date): The downgrade date of the transaction.
        dues (float | None | Unset): The dues for the membership downgrade transaction.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        downgrade_date = self.downgrade_date.isoformat()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        downgrade_date = isoparse(d.pop("downgrade_date")).date()
