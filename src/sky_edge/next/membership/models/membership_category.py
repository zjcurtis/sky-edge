...
from ..models.membership_category_membership_benefits_send_to import (
    MembershipCategoryMembershipBenefitsSendTo,
)
from ..models.membership_category_new_membership_expires_interval import (
...
class MembershipCategory:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_expires_date = _parse_default_expires_date(
            d.pop("default_expires_date", UNSET)
        )
        ...
        default_expires_days = _parse_default_expires_days(
            d.pop("default_expires_days", UNSET)
        )
        ...
        new_mem_expires_value = _parse_new_mem_expires_value(
            d.pop("new_mem_expires_value", UNSET)
        )
        ...
        if isinstance(_new_mem_expires_interval, Unset):
            ...
            new_mem_expires_interval = MembershipCategoryNewMembershipExpiresInterval(
                _new_mem_expires_interval
            )
        ...
        if isinstance(_send_benefits_to, Unset):
            ...
            send_benefits_to = MembershipCategoryMembershipBenefitsSendTo(
                _send_benefits_to
            )
