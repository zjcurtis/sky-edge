...
from ..models.renewal_notice_information_renewal_notice_type import (
...
class RenewalNoticeInformation:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_send_renewals_to, Unset):
            ...
            send_renewals_to = RenewalNoticeInformationRenewalNoticeType(
                _send_renewals_to
            )
        ...
        if isinstance(_renewal_type, Unset):
            ...
            renewal_type = RenewalNoticeInformationMembershipExpirationRange(
                _renewal_type
            )
