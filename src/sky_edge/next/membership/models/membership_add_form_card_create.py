...
from ..models.membership_add_form_card_create_membership_card_expires import (
    MembershipAddFormCardCreateMembershipCardExpires,
)
from ..models.membership_add_form_card_create_membership_cards_address_to_print import (
    MembershipAddFormCardCreateMembershipCardsAddressToPrint,
)
from ..models.membership_add_form_card_create_membership_cards_status import (
...
T = TypeVar("T", bound="MembershipAddFormCardCreate")


@_attrs_define
class MembershipAddFormCardCreate:
    """Create memberships and cards

    Attributes:
        name_on_card (str): Name of member on card
        primary (bool | Unset): Whether a card is a primary card
        ...
        card_expires (MembershipAddFormCardCreateMembershipCardExpires | Unset): Membership card's card expire
        address_to_print (MembershipAddFormCardCreateMembershipCardsAddressToPrint | Unset): Membership card's address
            to print Default: MembershipAddFormCardCreateMembershipCardsAddressToPrint.PRIMARYMEMBER.
        ...
        status (MembershipAddFormCardCreateMembershipCardsStatus | Unset): Status of membership card Default:
            MembershipAddFormCardCreateMembershipCardsStatus.NOTPRINTED.
    """
    ...
    card_expires: MembershipAddFormCardCreateMembershipCardExpires | Unset = UNSET
    address_to_print: (
        MembershipAddFormCardCreateMembershipCardsAddressToPrint | Unset
    ) = MembershipAddFormCardCreateMembershipCardsAddressToPrint.PRIMARYMEMBER
    ...
    status: MembershipAddFormCardCreateMembershipCardsStatus | Unset = (
        MembershipAddFormCardCreateMembershipCardsStatus.NOTPRINTED
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        card_expires: MembershipAddFormCardCreateMembershipCardExpires | Unset
        if isinstance(_card_expires, Unset):
            card_expires = UNSET
        else:
            card_expires = MembershipAddFormCardCreateMembershipCardExpires(
                _card_expires
            )
        ...
        if isinstance(_address_to_print, Unset):
            ...
            address_to_print = MembershipAddFormCardCreateMembershipCardsAddressToPrint(
                _address_to_print
            )
        ...
        if isinstance(_status, Unset):
            ...
            status = MembershipAddFormCardCreateMembershipCardsStatus(_status)

        membership_add_form_card_create = cls(
            name_on_card=name_on_card,
            primary=primary,
            editable=editable,
        ...
        return membership_add_form_card_create
