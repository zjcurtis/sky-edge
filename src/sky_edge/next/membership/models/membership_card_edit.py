...
from ..models.membership_card_edit_membership_card_expires import (
    MembershipCardEditMembershipCardExpires,
)
from ..models.membership_card_edit_membership_cards_address_to_print import (
    MembershipCardEditMembershipCardsAddressToPrint,
)
from ..models.membership_card_edit_membership_cards_status import (
...
T = TypeVar("T", bound="MembershipCardEdit")


@_attrs_define
class MembershipCardEdit:
    """Edit membership card request model for JSON Merge Patch operations
    ...
    Attributes:
        ...
        card_expires (MembershipCardEditMembershipCardExpires | Unset): Membership card's card expire
        address_to_print (MembershipCardEditMembershipCardsAddressToPrint | Unset): Membership card's address to print
        ...
        joint_member (bool | None | Unset): Whether the member is a joint member or not
        joint_member_id (int | None | Unset): Joint member ID
        card_member (bool | None | Unset): Whether a card member is checked
        name_on_card (None | str | Unset): Name of member on card
        no_of_cards (int | None | Unset): Number of cards
        ...
        status (MembershipCardEditMembershipCardsStatus | Unset): Status of membership card
        editable (bool | None | Unset): Flag indicating whether or not the member's name on the card is editable
    """

    constit_add_sal_id: int | None | Unset = UNSET
    relation_type: CodeTableEntry | Unset = UNSET
    card_expires: MembershipCardEditMembershipCardExpires | Unset = UNSET
    address_to_print: MembershipCardEditMembershipCardsAddressToPrint | Unset = UNSET
    valid_from_date: datetime.date | None | Unset = UNSET
    relationship_id: int | None | Unset = UNSET
    joint_member: bool | None | Unset = UNSET
    joint_member_id: int | None | Unset = UNSET
    card_member: bool | None | Unset = UNSET
    name_on_card: None | str | Unset = UNSET
    no_of_cards: int | None | Unset = UNSET
    ...
    status: MembershipCardEditMembershipCardsStatus | Unset = UNSET
    editable: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        joint_member: bool | None | Unset
        if isinstance(self.joint_member, Unset):
            joint_member = UNSET
        else:
        ...
        card_member: bool | None | Unset
        if isinstance(self.card_member, Unset):
            card_member = UNSET
        else:
        ...
        no_of_cards: int | None | Unset
        if isinstance(self.no_of_cards, Unset):
            no_of_cards = UNSET
        else:
        ...
        editable: bool | None | Unset
        if isinstance(self.editable, Unset):
            editable = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        constit_add_sal_id = _parse_constit_add_sal_id(
            d.pop("constit_add_sal_id", UNSET)
        )
        ...
        card_expires: MembershipCardEditMembershipCardExpires | Unset
        if isinstance(_card_expires, Unset):
            card_expires = UNSET
        else:
            card_expires = MembershipCardEditMembershipCardExpires(_card_expires)

        _address_to_print = d.pop("address_to_print", UNSET)
        address_to_print: MembershipCardEditMembershipCardsAddressToPrint | Unset
        if isinstance(_address_to_print, Unset):
            address_to_print = UNSET
        else:
            address_to_print = MembershipCardEditMembershipCardsAddressToPrint(
                _address_to_print
            )
        ...
        def _parse_joint_member(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        joint_member = _parse_joint_member(d.pop("joint_member", UNSET))
        ...
        def _parse_card_member(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        card_member = _parse_card_member(d.pop("card_member", UNSET))
        ...
        def _parse_no_of_cards(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        no_of_cards = _parse_no_of_cards(d.pop("no_of_cards", UNSET))
        ...
        last_printed_on_date = _parse_last_printed_on_date(
            d.pop("last_printed_on_date", UNSET)
        )
        ...
        status: MembershipCardEditMembershipCardsStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = MembershipCardEditMembershipCardsStatus(_status)

        def _parse_editable(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        editable = _parse_editable(d.pop("editable", UNSET))

        membership_card_edit = cls(
