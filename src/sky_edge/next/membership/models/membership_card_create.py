...
from ..models.membership_card_create_membership_card_expires import (
...
from ..models.membership_card_create_membership_cards_status import (
...
class MembershipCardCreate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_address_to_print, Unset):
            ...
            address_to_print = MembershipCardCreateMembershipCardsAddressToPrint(
                _address_to_print
            )
