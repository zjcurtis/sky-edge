...
class TaxDeclaration:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_constituent_pays_tax, Unset):
            ...
            constituent_pays_tax = TaxDeclarationConstituentPayTax(
        ...
        declaration_made_date = _parse_declaration_made_date(
            d.pop("declaration_made_date", UNSET)
        )
        ...
        declaration_start_date = _parse_declaration_start_date(
            d.pop("declaration_start_date", UNSET)
        )
        ...
        declaration_source_text = _parse_declaration_source_text(
            d.pop("declaration_source_text", UNSET)
        )
        ...
        declaration_indicator_text = _parse_declaration_indicator_text(
            d.pop("declaration_indicator_text", UNSET)
        )
        ...
        tax_payer_status_text = _parse_tax_payer_status_text(
            d.pop("tax_payer_status_text", UNSET)
        )
