...
from ..models.gift_tax_gift_aid_qualification_method import (
    GiftTaxGiftAidQualificationMethod,
)
from ..models.gift_tax_gift_aid_qualification_status import (
...
class GiftTax:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_gift_aid_qualification_method, Unset):
            ...
            gift_aid_qualification_method = GiftTaxGiftAidQualificationMethod(
        ...
        if isinstance(_gift_aid_qualification_status, Unset):
            ...
            gift_aid_qualification_status = GiftTaxGiftAidQualificationStatus(
                _gift_aid_qualification_status
            )
        ...
        def _parse_gift_splits(data: object) -> list[Splits] | None | Unset:
            ...
            try:
                ...
                for gift_splits_type_0_item_data in _gift_splits_type_0:
                    gift_splits_type_0_item = Splits.from_dict(
