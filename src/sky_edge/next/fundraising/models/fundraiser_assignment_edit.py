...
T = TypeVar("T", bound="FundraiserAssignmentEdit")


@_attrs_define
class FundraiserAssignmentEdit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fundraiser_assignment_edit = cls(
            amount=amount,
            appeal_id=appeal_id,
        ...
        fundraiser_assignment_edit.additional_properties = d
        return fundraiser_assignment_edit
