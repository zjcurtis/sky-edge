...
T = TypeVar("T", bound="FundraiserAssignmentAdd")


@_attrs_define
class FundraiserAssignmentAdd:
    ...
    solicitation purposes.
        ...
        Attributes:
            constituent_id (str): The immutable system record ID of the target constituent.
            fundraiser_id (str): The immutable system record ID of the fundraiser assigned to the constituent.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fundraiser_assignment_add.additional_properties = d
        return fundraiser_assignment_add
