...
from ..models.goal_read_type import GoalReadType

if TYPE_CHECKING:
    from ..models.currency import Currency


T = TypeVar("T", bound="GoalRead")
...
class GoalRead:
    ...
    funds, campaigns, or appeals.
        ...
        Attributes:
            id (str | Unset): The immutable system record ID of the fundraiser goal.
            ...
            fundraiser_id (str | Unset): The immutable system record ID of the fundraiser associated with the fundraiser
                goal.
            type_ (GoalReadType | Unset): The fundraiser goal type. Available values are <i>Campaign</i>, <i>Fund</i>,
    ...
    type_: GoalReadType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: GoalReadType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = GoalReadType(_type_)
        ...
        goal_read.additional_properties = d
        return goal_read
