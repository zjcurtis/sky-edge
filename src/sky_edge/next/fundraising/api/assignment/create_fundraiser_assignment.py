...
from ...models.fundraiser_assignment_add import FundraiserAssignmentAdd
from ...models.post_response import PostResponse


def _get_kwargs(
    *,
    body: FundraiserAssignmentAdd | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/fundraisers/assignments",
    }
...
def sync_detailed(
    *,
    ...
    """Fundraiser assignment (Create)

     Creates a fundraiser assignment.

    Args:
        body (FundraiserAssignmentAdd | Unset): Fundraiser constituents interact with other
