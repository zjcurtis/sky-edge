...
class GiftProcessingOptions:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if use_gross_amount_for_covenants is not UNSET:
            field_dict["use_gross_amount_for_covenants"] = (
                use_gross_amount_for_covenants
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_matching_gift_credit_option, Unset):
            ...
            matching_gift_credit_option = MatchingGiftCreditOption(
                _matching_gift_credit_option
            )
