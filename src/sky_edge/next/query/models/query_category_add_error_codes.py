...
T = TypeVar("T", bound="QueryCategoryAddErrorCodes")


@_attrs_define
class QueryCategoryAddErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:query-category-name-must-be-unique</td><td>Query category name must be
            unique.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_category_add_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        query_category_add_error_codes.additional_properties = d
        return query_category_add_error_codes
