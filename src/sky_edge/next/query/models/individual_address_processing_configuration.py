...
class IndividualAddressProcessingConfiguration:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.default_specific_address_type_or_enum, Unset):
            default_specific_address_type_or_enum = (
                self.default_specific_address_type_or_enum.to_dict()
            )
        ...
        if isinstance(self.filter_collection, Unset):
            ...
            for filter_collection_type_0_item_data in self.filter_collection:
                filter_collection_type_0_item = (
                    filter_collection_type_0_item_data.to_dict()
                )
        ...
        if default_specific_address_type_or_enum is not UNSET:
            field_dict["default_specific_address_type_or_enum"] = (
                default_specific_address_type_or_enum
            )
        ...
        if check_seasonal_date_range_type is not UNSET:
            field_dict["check_seasonal_date_range_type"] = (
                check_seasonal_date_range_type
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        _default_specific_address_type_or_enum = d.pop(
        ...
        if isinstance(_default_specific_address_type_or_enum, Unset):
            ...
            default_specific_address_type_or_enum = AddressTypeOrEnum.from_dict(
                _default_specific_address_type_or_enum
            )

        def _parse_check_seasonal_compare_date(
            data: object,
        ...
        check_seasonal_compare_date = _parse_check_seasonal_compare_date(
            d.pop("check_seasonal_compare_date", UNSET)
        )
        ...
        if isinstance(_check_seasonal_date_range_type, Unset):
            ...
            check_seasonal_date_range_type = AddressProcessingDateRange(
                _check_seasonal_date_range_type
            )

        def _parse_filter_collection(
            data: object,
        ) -> list[AddressProcessingFilter] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
