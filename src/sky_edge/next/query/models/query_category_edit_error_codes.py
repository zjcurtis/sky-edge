...
T = TypeVar("T", bound="QueryCategoryEditErrorCodes")


@_attrs_define
class QueryCategoryEditErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:general-category-cannot-be-renamed</td><td>General category cannot be
            renamed.</td></tr><tr><td>urn:blackbaud:general-category-cannot-be-moved</td><td>General category cannot be
            moved.</td></tr><tr><td>urn:blackbaud:category-cannot-be-renamed-to-general</td><td>Category cannot be renamed
            to general.</td></tr><tr><td>urn:blackbaud:sequence-cannot-be-less-than-or-equal-to-one</td><td>Sequence cannot
            be less than or equal to one.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_category_edit_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        query_category_edit_error_codes.additional_properties = d
        return query_category_edit_error_codes
