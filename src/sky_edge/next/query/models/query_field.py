...
class QueryField:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.allowed_filter_operators, Unset):
            ...
            ) in self.allowed_filter_operators:
                allowed_filter_operators_type_0_item = (
                    allowed_filter_operators_type_0_item_data.value
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        available_field_name = _parse_available_field_name(
            d.pop("available_field_name", UNSET)
        )
        ...
        selected_field_name = _parse_selected_field_name(
            d.pop("selected_field_name", UNSET)
        )
        ...
        def _parse_allowed_filter_operators(
            data: object,
        ) -> list[AllowedFilterOperators] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for (
                    allowed_filter_operators_type_0_item_data
                ) in _allowed_filter_operators_type_0:
                    allowed_filter_operators_type_0_item = AllowedFilterOperators(
                        allowed_filter_operators_type_0_item_data
                    )

                    allowed_filter_operators_type_0.append(
                        allowed_filter_operators_type_0_item
                    )
        ...
        allowed_filter_operators = _parse_allowed_filter_operators(
            d.pop("allowed_filter_operators", UNSET)
        )
        ...
        summary_has_available_fields = _parse_summary_has_available_fields(
            d.pop("summary_has_available_fields", UNSET)
        )
        ...
        summary_has_default_filters = _parse_summary_has_default_filters(
            d.pop("summary_has_default_filters", UNSET)
        )
