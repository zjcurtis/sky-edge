...
T = TypeVar("T", bound="ExecuteQueryErrorCodes")


@_attrs_define
class ExecuteQueryErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:invalid-query-for-execution</td><td>Invalid query for
            execution.</td></tr><tr><td>urn:blackbaud:invalid-query-fields-for-execution</td><td>The following fields are
            not supported as criteria or as sort fields: {0} Remove the fields and try again. View Knowledgebase article
            202956 for more information.</td></tr><tr><td>urn:blackbaud:execution-unsupported</td><td>This query contains
            fields or features not currently supported. Support will be available in a future
            release.</td></tr><tr><td>urn:blackbaud:select-from-query-loop-detected</td><td>This query results in an invalid
            select from query loop.</td></tr><tr><td>urn:blackbaud:unsupported-age-or-birthdate-in-query-
            fields</td><td>Query does not support birth date criteria more specific than a full month or the use of age or
            birth date as sort fields. Remove the fields and try again. View Knowledgebase article 202956 for more
            information.</td></tr><tr><td>urn:blackbaud:invalid-fe-summary-field-filter-value-count</td><td>The filter
            values for summary field instance {0} are invalid due to an entitlements change. Remove and re-add the summary
            field with the proper filters and try again.</td></tr><tr><td>urn:blackbaud:results-file-name-too-
            long</td><td>The results_file_name must be 30 characters or less.</td></tr><tr><td>urn:blackbaud:invalid-fe-
            summary-field-filter-value-format</td><td>The filter values for summary field instance {0} are invalid due to an
            entitlements change. Remove and re-add the summary field with the proper filters and try
            again.</td></tr><tr><td>urn:blackbaud:invalid-type-id</td><td>Invalid query
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execute_query_error_codes.additional_properties = d
        return execute_query_error_codes
