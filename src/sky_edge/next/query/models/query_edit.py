...
class QueryEdit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        others_can_execute = _parse_others_can_execute(
            d.pop("others_can_execute", UNSET)
        )
        ...
        suppress_duplicates = _parse_suppress_duplicates(
            d.pop("suppress_duplicates", UNSET)
        )
        ...
        def _parse_select_fields(data: object) -> list[SelectFieldWrite] | None | Unset:
            ...
            try:
                ...
                for select_fields_type_0_item_data in _select_fields_type_0:
                    select_fields_type_0_item = SelectFieldWrite.from_dict(
        ...
        def _parse_sort_fields(data: object) -> list[SortFieldWrite] | None | Unset:
            ...
            try:
                ...
                for sort_fields_type_0_item_data in _sort_fields_type_0:
                    sort_fields_type_0_item = SortFieldWrite.from_dict(
        ...
        def _parse_summary_fields(
            data: object,
        ) -> list[SummaryFieldWrite] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for summary_fields_type_0_item_data in _summary_fields_type_0:
                    summary_fields_type_0_item = SummaryFieldWrite.from_dict(
