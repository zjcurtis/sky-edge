...
if TYPE_CHECKING:
    from ..models.filter_field_write_filter_values_type_0_item import (
...
class FilterFieldWrite:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_filter_values(
            data: object,
        ) -> list[FilterFieldWriteFilterValuesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for filter_values_type_0_item_data in _filter_values_type_0:
                    filter_values_type_0_item = (
                        FilterFieldWriteFilterValuesType0Item.from_dict(
                ...
                pass
            return cast(
                list[FilterFieldWriteFilterValuesType0Item] | None | Unset, data
            )
