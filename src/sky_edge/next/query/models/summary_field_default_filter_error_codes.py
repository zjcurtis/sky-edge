...
T = TypeVar("T", bound="SummaryFieldDefaultFilterErrorCodes")


@_attrs_define
class SummaryFieldDefaultFilterErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:query-field-is-not-parameterized-summary-field</td><td>The provided query
            field ID {0} is not a parameterized summary query field.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary_field_default_filter_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        summary_field_default_filter_error_codes.additional_properties = d
        return summary_field_default_filter_error_codes
