...
T = TypeVar("T", bound="QueryCategoryDeleteErrorCodes")


@_attrs_define
class QueryCategoryDeleteErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:general-query-category-cannot-be-deleted</td><td>General query category
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        query_category_delete_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        query_category_delete_error_codes.additional_properties = d
        return query_category_delete_error_codes
