...
if TYPE_CHECKING:
    from ..models.individual_address_processing_configuration import (
        IndividualAddressProcessingConfiguration,
    )
    from ..models.organization_address_processing_configuration import (
...
class AddressProcessingConfiguration:
    ...
    individual_address_processing_configuration: (
        IndividualAddressProcessingConfiguration | Unset
    ) = UNSET
    organization_address_processing_configuration: (
        OrganizationAddressProcessingConfiguration | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.individual_address_processing_configuration, Unset):
            individual_address_processing_configuration = (
                self.individual_address_processing_configuration.to_dict()
            )
        ...
        if not isinstance(self.organization_address_processing_configuration, Unset):
            organization_address_processing_configuration = (
                self.organization_address_processing_configuration.to_dict()
            )
        ...
        if individual_address_processing_configuration is not UNSET:
            field_dict["individual_address_processing_configuration"] = (
                individual_address_processing_configuration
            )
        if organization_address_processing_configuration is not UNSET:
            field_dict["organization_address_processing_configuration"] = (
                organization_address_processing_configuration
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        _individual_address_processing_configuration = d.pop(
        ...
        if isinstance(_individual_address_processing_configuration, Unset):
            ...
            individual_address_processing_configuration = (
                IndividualAddressProcessingConfiguration.from_dict(
                    _individual_address_processing_configuration
                )
            )

        _organization_address_processing_configuration = d.pop(
        ...
        if isinstance(_organization_address_processing_configuration, Unset):
            ...
            organization_address_processing_configuration = (
                OrganizationAddressProcessingConfiguration.from_dict(
