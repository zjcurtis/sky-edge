...
@_attrs_define
class QueryNode:
    """A node in the available fields tree

    Attributes:
        fields (list[QueryField] | None | Unset): The fields of the node, such as for Attribute Types or Specific Types
        id (int | Unset): The ID of the node
        name (None | str | Unset): The name of the node to display
    """
