...
T = TypeVar("T", bound="GetQueryListErrorCodes")


@_attrs_define
class GetQueryListErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            range of 1753 to 9999.</td></tr><tr><td>urn:blackbaud:invalid-query-type-parameters</td><td>Only one of the
            query_type_id/query_type_ids parameters may be provided in the request.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_query_list_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_query_list_error_codes.additional_properties = d
        return get_query_list_error_codes
