...
T = TypeVar("T", bound="AvailableFieldsSearchErrorCodes")


@_attrs_define
class AvailableFieldsSearchErrorCodes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            {1}</td></tr><tr><td>urn:blackbaud:required-field</td><td>The required field '{0}' does not have a
            value.</td></tr><tr><td>urn:blackbaud:invalid-integer-value</td><td>{0} is not a valid value for
            {1}.</td></tr><tr><td>urn:blackbaud:invalid-available-fields-search-continuation-token</td><td>An invalid
            available fields search continuation token was provided.  Use a value returned from a previous available field
            search.</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        available_fields_search_error_codes = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        available_fields_search_error_codes.additional_properties = d
        return available_fields_search_error_codes
