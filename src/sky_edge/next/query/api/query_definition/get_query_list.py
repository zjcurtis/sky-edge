...
from ...models.get_query_list_error_codes import GetQueryListErrorCodes
from ...models.get_query_list_module import GetQueryListModule
from ...models.get_query_list_product import GetQueryListProduct
from ...models.get_query_list_response import GetQueryListResponse
...
def _get_kwargs(
    *,
    product: GetQueryListProduct,
    module: GetQueryListModule,
    offset: int | Unset = UNSET,
    query_type_id: int | Unset = UNSET,
...
) -> GetQueryListErrorCodes | GetQueryListResponse | ProblemDetails | None:
    if response.status_code == 200:
        response_200 = GetQueryListResponse.from_dict(response.json())

        return response_200

    if response.status_code == 400:
        response_400 = GetQueryListErrorCodes.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetQueryListErrorCodes | GetQueryListResponse | ProblemDetails]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        GetQueryListErrorCodes | GetQueryListResponse | ProblemDetails
    """
