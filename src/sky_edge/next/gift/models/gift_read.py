    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _acknowledgements is not UNSET:
            ...
            for acknowledgements_item_data in _acknowledgements:
                acknowledgements_item = AcknowledgementRead.from_dict(
        ...
        if isinstance(_recurring_gift_schedule, Unset):
            ...
            recurring_gift_schedule = RecurringGiftScheduleRead.from_dict(
        ...
        if isinstance(_recurring_gift_status_date, Unset):
            ...
            recurring_gift_status_date = FuzzyDate.from_dict(
                _recurring_gift_status_date
            )
        ...
        gift_read.additional_properties = d
        return gift_read
