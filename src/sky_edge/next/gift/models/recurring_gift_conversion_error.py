...
T = TypeVar("T", bound="RecurringGiftConversionError")


@_attrs_define
class RecurringGiftConversionError:
    """An error when attempting to convert a recurring gift.  This indicates the specific reason that a recurring gift
    cannot be converted to automated.

        Attributes:
            gift_id (str | Unset): The immutable system record ID of the gift.
            lookup_id (str | Unset): The lookup ID of the gift.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recurring_gift_conversion_error = cls(
            gift_id=gift_id,
            lookup_id=lookup_id,
        ...
        recurring_gift_conversion_error.additional_properties = d
        return recurring_gift_conversion_error
