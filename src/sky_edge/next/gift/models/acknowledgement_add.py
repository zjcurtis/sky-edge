...
T = TypeVar("T", bound="AcknowledgementAdd")


@_attrs_define
class AcknowledgementAdd:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acknowledgement_add = cls(
            date=date,
            letter=letter,
            status=status,
        )

        acknowledgement_add.additional_properties = d
        return acknowledgement_add
