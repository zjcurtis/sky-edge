...
T = TypeVar("T", bound="ApiCollectionCustomFieldRead")


@_attrs_define
class ApiCollectionCustomFieldRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_collection_custom_field_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_custom_field_read.additional_properties = d
        return api_collection_custom_field_read
