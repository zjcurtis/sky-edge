...
if TYPE_CHECKING:
    ...
    from ..models.tribute_add import TributeAdd


T = TypeVar("T", bound="GiftBatchGiftAdd")


@_attrs_define
class GiftBatchGiftAdd:
    ...
    with them to ensure that they are properly allocated and acknowledged.
        ...
        Attributes:
            ...
            tributes (list[TributeAdd] | Unset): A collection representing existing tribute records to add with the gift.
    ...
    tributes: list[TributeAdd] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _tributes is not UNSET:
            ...
            for tributes_item_data in _tributes:
                tributes_item = TributeAdd.from_dict(tributes_item_data)
        ...
        if _acknowledgements is not UNSET:
            ...
            for acknowledgements_item_data in _acknowledgements:
                acknowledgements_item = AcknowledgementAdd.from_dict(
                    acknowledgements_item_data
                )
        ...
        if isinstance(_recurring_gift_schedule, Unset):
            ...
            recurring_gift_schedule = RecurringGiftScheduleAdd.from_dict(
                _recurring_gift_schedule
            )
        ...
        gift_batch_gift_add.additional_properties = d
        return gift_batch_gift_add
