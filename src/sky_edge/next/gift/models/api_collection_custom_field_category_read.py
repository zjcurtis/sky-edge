...
T = TypeVar("T", bound="ApiCollectionCustomFieldCategoryRead")


@_attrs_define
class ApiCollectionCustomFieldCategoryRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_collection_custom_field_category_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_custom_field_category_read.additional_properties = d
        return api_collection_custom_field_category_read
