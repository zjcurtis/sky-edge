...
T = TypeVar("T", bound="TableEntryCreate")


@_attrs_define
class TableEntryCreate:
    """New table entry to add

    Attributes:
        long_description (str): The long description of the entry.
        is_active (bool | Unset): The active status of the entry. Default: True.
        ...
        sequence (int | None | Unset): The location to insert the new entry in the order.
