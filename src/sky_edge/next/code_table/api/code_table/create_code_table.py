...
from ...models.code_table_create import CodeTableCreate
from ...models.post_response import PostResponse


def _get_kwargs(
    *,
    body: CodeTableCreate | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Args:
        body (CodeTableCreate | Unset): New code table to be added
