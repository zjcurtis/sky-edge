...
T = TypeVar("T", bound="OpportunityAdd")


@_attrs_define
class OpportunityAdd:
    ...
    manage information about fundraising activities and the effectiveness of your efforts.
        ...
        Attributes:
            constituent_id (str): The immutable system record ID of the constituent associated with the opportunity.
            name (str): The name that identifies the opportunity throughout the program, such as in lists or on constituent
                records. Character limit: 255.
            purpose (str): The intended use for any money raised as a result of the opportunity. Available values are the
                entries in the <a href="https://developer.sky.blackbaud.com/docs/services/58e3b2597c1af25c58b9c4e3/operations/Li
                stOpportunityPurposes"><b>Purposes</b></a> table.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        opportunity_add.additional_properties = d
        return opportunity_add
