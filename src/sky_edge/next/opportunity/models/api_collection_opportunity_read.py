...
T = TypeVar("T", bound="ApiCollectionOpportunityRead")


@_attrs_define
class ApiCollectionOpportunityRead:
    ...
    large data sets. This entity includes helpful metadata and properties to paginate and iterate through the data.
        ...
        Attributes:
            ...
            value (list[OpportunityRead] | Unset): The set of items included in the response. This may be a subset of the
                items in the collection.
    """

    count: int | Unset = UNSET
    next_link: str | Unset = UNSET
    value: list[OpportunityRead] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _value is not UNSET:
            ...
            for value_item_data in _value:
                value_item = OpportunityRead.from_dict(value_item_data)

                value.append(value_item)

        api_collection_opportunity_read = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_opportunity_read.additional_properties = d
        return api_collection_opportunity_read
