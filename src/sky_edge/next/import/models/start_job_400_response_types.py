...
T = TypeVar("T", bound="StartJob400ResponseTypes")


@_attrs_define
class StartJob400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:job-not-in-
            pending-state</td><td>JobNotInPendingState</td></tr><tr><td>urn:blackbaud:missing-import-job-
            file</td><td>MissingImportJobFile</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_job_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        start_job_400_response_types.additional_properties = d
        return start_job_400_response_types
