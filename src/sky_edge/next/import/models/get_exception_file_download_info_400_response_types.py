...
T = TypeVar("T", bound="GetExceptionFileDownloadInfo400ResponseTypes")


@_attrs_define
class GetExceptionFileDownloadInfo400ResponseTypes:
    ...
    Attributes:
        type_ (None | str | Unset): A URI reference [RFC3986] that identifies the problem type. This specification
            ...
            validation rule was violated, such as a missing required field.</td></tr><tr><td>urn:blackbaud:invalid-empty-
            value</td><td>InvalidEmptyValue</td></tr><tr><td>urn:blackbaud:job-not-completed-or-
            failed</td><td>JobNotCompletedOrFailed</td></tr></table>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_exception_file_download_info_400_response_types = cls(
            type_=type_,
            title=title,
            status=status,
            detail=detail,
        ...
        get_exception_file_download_info_400_response_types.additional_properties = d
        return get_exception_file_download_info_400_response_types
