...
from ...models.constituent_event_participation_collection import (
...
def _get_kwargs(
    ...
    *,
    ...
    invitation_status: list[GetConstituentEventParticipationInvitationStatusItem]
    | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ConstituentEventParticipationCollection.from_dict(
            response.json()
        )
