...
from ...models.create_event_fee import CreateEventFee
...
def _get_kwargs(
    event_id: str,
    *,
    body: CreateEventFee | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/events/{event_id}/eventfees".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        event_id (str):
        body (CreateEventFee | Unset): Event fees are how much an organization charges for
