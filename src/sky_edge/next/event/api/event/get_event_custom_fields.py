...
from ...models.custom_field_collection import CustomFieldCollection
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/events/{event_id}/customfields".format(
...
) -> CustomFieldCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = CustomFieldCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CustomFieldCollection | list[ServiceError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get event custom fields (PREVIEW)

     Returns a list of event custom fields.
...
def sync(
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Returns:
        CustomFieldCollection | list[ServiceError]
    """
