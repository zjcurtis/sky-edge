...
from ...models.create_custom_field_request import CreateCustomFieldRequest
...
def _get_kwargs(
    *,
    body: CreateCustomFieldRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/events/customfields",
    }
...
def sync_detailed(
    *,
    ...
    """Create event custom field (PREVIEW)
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Args:
        body (CreateCustomFieldRequest | Unset): Creates a new custom field request for the event.
