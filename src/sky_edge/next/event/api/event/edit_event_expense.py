...
from ...models.edit_event_expense import EditEventExpense
...
def _get_kwargs(
    expense_id: str,
    *,
    body: EditEventExpense | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Args:
        expense_id (str):
        body (EditEventExpense | Unset): An event expense is a debt incurred from hosting an
            event.
