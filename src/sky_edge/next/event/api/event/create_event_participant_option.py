...
from ...models.create_event_participant_option import CreateEventParticipantOption
...
def _get_kwargs(
    event_id: str,
    *,
    body: CreateEventParticipantOption | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        event_id (str):
        body (CreateEventParticipantOption | Unset): Event participant options are fields that
