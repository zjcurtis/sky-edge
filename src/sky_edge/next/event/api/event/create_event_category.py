...
from ...models.create_event_category import CreateEventCategory
...
def _get_kwargs(
    *,
    body: CreateEventCategory | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateEventCategory | Unset): Event categories help group different types of events.
