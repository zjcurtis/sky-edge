...
from ...models.get_event_participant_list_event_fee_include_type import (
    GetEventParticipantListEventFeeIncludeType,
)
from ...models.get_event_participant_list_invitation_status_item import (
    GetEventParticipantListInvitationStatusItem,
)
from ...models.get_event_participant_list_online_data_health_item import (
...
from ...models.get_event_participant_list_rsvp_status_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    invitation_status: list[GetEventParticipantListInvitationStatusItem]
    | Unset = UNSET,
    ...
    online_data_health: list[GetEventParticipantListOnlineDataHealthItem]
    | Unset = UNSET,
