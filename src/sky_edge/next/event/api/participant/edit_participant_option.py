...
from ...models.edit_participant_option import EditParticipantOption
...
def _get_kwargs(
    option_id: str,
    *,
    body: EditParticipantOption | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/v1/participantoptions/{option_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Edit a participant option

     Edits the details about a participant option.

    Args:
        option_id (str):
        body (EditParticipantOption | Unset): A participant option
