...
from ...models.create_participant_fee_payment import CreateParticipantFeePayment
...
def _get_kwargs(
    participant_id: str,
    *,
    body: CreateParticipantFeePayment | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        participant_id (str):
        body (CreateParticipantFeePayment | Unset): Participant fee payments are payments toward
