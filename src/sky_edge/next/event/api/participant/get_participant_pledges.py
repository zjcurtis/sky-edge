...
from ...models.participant_pledge_collection import ParticipantPledgeCollection
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/participants/{participant_id}/pledges".format(
...
) -> ParticipantPledgeCollection | list[ServiceError] | None:
    if response.status_code == 200:
        response_200 = ParticipantPledgeCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ParticipantPledgeCollection | list[ServiceError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get participant pledges (PREVIEW)

     Returns the pledges for a participant.
...
def sync(
    ...
    ***This endpoint is in PREVIEW and may be changed or removed at any time.***
    ...
    Returns:
        ParticipantPledgeCollection | list[ServiceError]
    """
