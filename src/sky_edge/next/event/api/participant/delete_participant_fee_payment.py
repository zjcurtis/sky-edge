...
def _get_kwargs(
    participant_fee_payment_id: str,
) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/participantfeepayments/{participant_fee_payment_id}".format(
            participant_fee_payment_id=quote(str(participant_fee_payment_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Delete a participant fee payment

     Deletes a participant fee payment for a participant.
    ...
    kwargs = _get_kwargs(
        participant_fee_payment_id=participant_fee_payment_id,
    )
