...
from ...models.create_participant_fee import CreateParticipantFee
...
def _get_kwargs(
    participant_id: str,
    *,
    body: CreateParticipantFee | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        participant_id (str):
        body (CreateParticipantFee | Unset): Participant fees are how much an individual or
            organization pays to participate in or attend the event.
