...
from ...models.create_participant_donation import CreateParticipantDonation
...
def _get_kwargs(
    participant_id: str,
    *,
    body: CreateParticipantDonation | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        participant_id (str):
        body (CreateParticipantDonation | Unset): Participant donations are donations made toward
            the event.
