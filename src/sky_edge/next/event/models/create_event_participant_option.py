...
from ..models.create_event_participant_option_input_type import (
    CreateEventParticipantOptionInputType,
)

if TYPE_CHECKING:
    from ..models.create_participant_option_list_option import (
...
class CreateEventParticipantOption:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_list_options(
            data: object,
        ) -> list[CreateParticipantOptionListOption] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for list_options_type_0_item_data in _list_options_type_0:
                    list_options_type_0_item = (
                        CreateParticipantOptionListOption.from_dict(
