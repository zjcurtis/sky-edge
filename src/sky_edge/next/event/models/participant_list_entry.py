...
from ..models.participant_list_entry_invitation_status import (
    ParticipantListEntryInvitationStatus,
)
from ..models.participant_list_entry_online_data_health import (
...
if TYPE_CHECKING:
    ...
    from ..models.participant_entry_participant_option import (
        ParticipantEntryParticipantOption,
    )
    from ..models.participant_entry_registration_form import (
        ParticipantEntryRegistrationForm,
    )
    from ..models.participant_list_participant_summary import (
...
class ParticipantListEntry:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.participant_options, Unset):
            ...
            for participant_options_type_0_item_data in self.participant_options:
                participant_options_type_0_item = (
                    participant_options_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_guests(
            data: object,
        ) -> list[ParticipantListParticipantSummary] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for guests_type_0_item_data in _guests_type_0:
                    guests_type_0_item = ParticipantListParticipantSummary.from_dict(
                        guests_type_0_item_data
                    )
        ...
        def _parse_memberships(data: object) -> list[Membership] | None | Unset:
            ...
            try:
                ...
                for memberships_type_0_item_data in _memberships_type_0:
                    memberships_type_0_item = Membership.from_dict(
                        memberships_type_0_item_data
                    )
        ...
        def _parse_participant_options(
            data: object,
        ) -> list[ParticipantEntryParticipantOption] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for participant_options_type_0_item_data in _participant_options_type_0:
                    participant_options_type_0_item = (
                        ParticipantEntryParticipantOption.from_dict(
        ...
        participant_options = _parse_participant_options(
            d.pop("participant_options", UNSET)
        )
        ...
        if isinstance(_registration_form, Unset):
            ...
            registration_form = ParticipantEntryRegistrationForm.from_dict(
                _registration_form
            )
        ...
        if isinstance(_online_data_health, Unset):
            ...
            online_data_health = ParticipantListEntryOnlineDataHealth(
                _online_data_health
            )
        ...
        def _parse_fees(data: object) -> list[ParticipantEntryFee] | None | Unset:
            ...
            try:
                ...
                for fees_type_0_item_data in _fees_type_0:
                    fees_type_0_item = ParticipantEntryFee.from_dict(
                        fees_type_0_item_data
                    )
