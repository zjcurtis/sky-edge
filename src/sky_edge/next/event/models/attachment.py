...
class Attachment:
    ...
    stored and managed externally.
        ...
        Attributes:
            type_ (AttachmentType): The attachment type.<p>Available values:</p><ul><li><i>Link</i> - Link attachments are
                links to files, such as images, blog posts, or YouTube videos, that are online or in a cloud storage account.
                They are stored and managed externally.</li><li><i>Physical</i> - Physical attachments are uploaded files, such
                as images, PDFs, or Word documents, that are saved locally or on the network. They are stored and managed in the
                system.</li></ul>
            id (None | str | Unset): The immutable system record ID of the attachment.
            parent_id (None | str | Unset): The parent object's immutable system record ID.
            file_size (int | None | Unset): The file size in bytes. For physical attachments only.
            file_url (None | str | Unset): The URL for the file. For physical attachments only. Contains a time-bound
                signature that limits access to 30 minutes.
            content_type (None | str | Unset): The content type. For physical attachments only.
            thumbnail_uri (None | str | Unset): The URL for a thumbnail. For physical attachments that are images only.
                Contains a time-bound signature that limits access to 30 minutes.
    ...
    thumbnail_uri: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        thumbnail_uri: None | str | Unset
        if isinstance(self.thumbnail_uri, Unset):
            thumbnail_uri = UNSET
        else:
        ...
        if thumbnail_uri is not UNSET:
            field_dict["thumbnail_uri"] = thumbnail_uri
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = AttachmentType(d.pop("type"))
        ...
        def _parse_thumbnail_uri(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        thumbnail_uri = _parse_thumbnail_uri(d.pop("thumbnail_uri", UNSET))
