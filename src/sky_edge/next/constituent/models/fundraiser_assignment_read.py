...
class FundraiserAssignmentRead:
    ...
    solicitation purposes
        ...
        Attributes:
            id (str | Unset): The immutable system record ID of the fundraiser assignment.
            ...
            constituent_id (str | Unset): The immutable system record ID of the constituent assigned to the fundraiser.
            end (datetime.datetime | Unset): The fundraiser assignment end date. Uses <a
            ...
            fundraiser_id (str | Unset): The immutable system record ID of the fundraiser.
            start (datetime.datetime | Unset): The fundraiser assignment start date. Uses <a
            ...
            type_ (str | Unset): The type of fundraiser. Available values are the entries in the <a href="https://developer.
                sky.blackbaud.com/docs/services/58bdd6c8d7dcde06046081d7/operations/5ad64755a9db9517f8d9767e"><b>Solicitor
                Type</b></a> table.
    """
