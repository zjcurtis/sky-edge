...
from ..models.constituent_list_item_fundraiser_status import (
...
class ConstituentListItem:
    ...
    constituent_assigned_fundraisers: list[ConstituentAssignedFundraiser] | Unset = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.constituent_assigned_fundraisers, Unset):
            ...
            ) in self.constituent_assigned_fundraisers:
                constituent_assigned_fundraisers_item = (
                    constituent_assigned_fundraisers_item_data.to_dict()
                )
                constituent_assigned_fundraisers.append(
                    constituent_assigned_fundraisers_item
                )
        ...
        if constituent_assigned_fundraisers is not UNSET:
            field_dict["constituent_assigned_fundraisers"] = (
                constituent_assigned_fundraisers
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.address_read import AddressRead
        from ..models.constituent_assigned_fundraiser import (
        ...
        _constituent_assigned_fundraisers = d.pop(
            "constituent_assigned_fundraisers", UNSET
        )
        constituent_assigned_fundraisers: (
            list[ConstituentAssignedFundraiser] | Unset
        ) = UNSET
        if _constituent_assigned_fundraisers is not UNSET:
            constituent_assigned_fundraisers = []
            for (
                constituent_assigned_fundraisers_item_data
            ) in _constituent_assigned_fundraisers:
                constituent_assigned_fundraisers_item = (
                    ConstituentAssignedFundraiser.from_dict(
                        constituent_assigned_fundraisers_item_data
                    )
                )
