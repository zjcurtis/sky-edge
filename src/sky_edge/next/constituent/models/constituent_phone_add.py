...
T = TypeVar("T", bound="ConstituentPhoneAdd")


@_attrs_define
class ConstituentPhoneAdd:
    """Defines the shape of a phone for adding with a constituent.
    ...
    Attributes:
        ...
        primary (bool | Unset): Indicates whether this is the constituent's primary phone number.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        constituent_phone_add.additional_properties = d
        return constituent_phone_add
