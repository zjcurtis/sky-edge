...
T = TypeVar("T", bound="ApiCollectionOfString")


@_attrs_define
class ApiCollectionOfString:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_collection_of_string = cls(
            count=count,
            next_link=next_link,
            value=value,
        )

        api_collection_of_string.additional_properties = d
        return api_collection_of_string
