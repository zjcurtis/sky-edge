...
T = TypeVar("T", bound="AliasAddCollectionAlias")


@_attrs_define
class AliasAddCollectionAlias:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alias_add_collection_alias = cls(
            name=name,
            type_=type_,
        )

        alias_add_collection_alias.additional_properties = d
        return alias_add_collection_alias
