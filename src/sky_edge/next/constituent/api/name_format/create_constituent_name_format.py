...
from ...models.name_format_add import NameFormatAdd
from ...models.post_response import PostResponse


def _get_kwargs(
    *,
    body: NameFormatAdd | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (NameFormatAdd | Unset): Name formats define how to address constituents in
