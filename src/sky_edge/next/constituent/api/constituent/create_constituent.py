...
from ...models.constituent_add import ConstituentAdd
from ...models.post_response import PostResponse


def _get_kwargs(
    *,
    body: ConstituentAdd | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (ConstituentAdd | Unset): Constituents are the individuals and organizations who
