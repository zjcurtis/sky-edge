...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/educations/customfields/categories/values",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Education custom field code table category values

     Returns a list of values for the specified code table category.
