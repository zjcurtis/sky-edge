...
from ...models.api_collection_of_relationship_read import (
...
def sync_detailed(
    *,
    ...
    <p />
    The default sorting behavior is to list relationships in ascending order based on when they were
    created.
    <p />
    However, the <code>last_modified</code> parameter overrides the default sorting behavior to list
    relationships in ascending order based on when they were last modified. The
    <code>last_modified</code> parameter also adds the <code>sort_token</code> parameter to the
    <code>next_link</code> URL to ensure that relationships are stably sorted and that order persists
    ...
    sorting behavior is to list relationships based on when they were last modified.
    <p />
